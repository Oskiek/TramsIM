...
public class EventManager {
    ...
    public void entityJoinWorldEvent(EntityJoinWorldEvent event) {
        ...
        if(Loader.isModLoaded("tramsim")) return; //If detected TramsIM, do not send message
            hasFired=true;
            Message(event);
    }
    void Message(EntityJoinWorldEvent event)
    {
        ...
        ((EntityPlayer) event.entity).addChatMessage(new ChatComponentText("- Metro in Motion " + MetroIM.MOD_VERSION));
