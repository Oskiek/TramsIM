...
public class Tail3700_v2 extends ModelBase //Same as Filename
{
    ...
    {bodyModel[0] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 0
        ...
        bodyModel[102] = new ModelRendererTurbo(this, 281, 25, textureX, textureY); // Box 111
        bodyModel[103] = new ModelRendererTurbo(this, 305, 25, textureX, textureY); // Box 112
        bodyModel[104] = new ModelRendererTurbo(this, 489, 57, textureX, textureY); // Box 116
        bodyModel[105] = new ModelRendererTurbo(this, 273, 65, textureX, textureY); // Box 128
        bodyModel[106] = new ModelRendererTurbo(this, 345, 57, textureX, textureY); // Box 115
        bodyModel[107] = new ModelRendererTurbo(this, 377, 57, textureX, textureY); // Box 113
        bodyModel[108] = new ModelRendererTurbo(this, 10, 80, textureX, textureY); // Box 131
        bodyModel[109] = new ModelRendererTurbo(this, 23, 80, textureX, textureY); // Box 132
        bodyModel[110] = new ModelRendererTurbo(this, 2, 80, textureX, textureY); // Box 133
        bodyModel[111] = new ModelRendererTurbo(this, 2, 80, textureX, textureY); // Box 134
        bodyModel[112] = new ModelRendererTurbo(this, 281, 1, textureX, textureY); // Box 135
        bodyModel[113] = new ModelRendererTurbo(this, 465, 25, textureX, textureY); // Box 136
        bodyModel[114] = new ModelRendererTurbo(this, 377, 17, textureX, textureY); // Box 137
        bodyModel[115] = new ModelRendererTurbo(this, 297, 65, textureX, textureY); // Box 139
        bodyModel[116] = new ModelRendererTurbo(this, 377, 1, textureX, textureY); // Box 22
        bodyModel[117] = new ModelRendererTurbo(this, 377, 1, textureX, textureY); // Box 142
        bodyModel[118] = new ModelRendererTurbo(this, 297, 65, textureX, textureY); // Box 134
        bodyModel[119] = new ModelRendererTurbo(this, 332, 70, textureX, textureY); // Box 119
        bodyModel[120] = new ModelRendererTurbo(this, 332, 70, textureX, textureY); // Box 120
        ...
        bodyModel[102].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 5F); // Box 111
        bodyModel[102].setRotationPoint(33F, 0F, -9F);

        bodyModel[103].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0F, 0F, 5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 112
        bodyModel[103].setRotationPoint(33F, 0F, 8F);

        bodyModel[104].addBox(0F, 0F, 0F, 2, 7, 5, 0F); // Box 116
        bodyModel[104].setRotationPoint(33F, -7F, 4F);

        bodyModel[105].addBox(0F, 0F, 0F, 2, 7, 5, 0F); // Box 128
        bodyModel[105].setRotationPoint(33F, -7F, -9F);

        bodyModel[106].addShapeBox(0F, 0F, 0F, 2, 9, 3, 0F,0F, 0F, 0.4F, 0F, 0F, 0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 115
        bodyModel[106].setRotationPoint(33F, -16F, 6F);

        bodyModel[107].addShapeBox(0F, 0F, 0F, 2, 9, 3, 0F,0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, 0.4F, 0F, 0F, 0.4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 113
        bodyModel[107].setRotationPoint(33F, -16F, -9F);

        bodyModel[108].addBox(0F, 0F, 0F, 3, 1, 3, 0F); // Box 131
        bodyModel[108].setRotationPoint(-31F, -4F, -5.5F);

        bodyModel[109].addBox(0F, 0F, 0F, 1, 5, 3, 0F); // Box 132
        bodyModel[109].setRotationPoint(-28F, -9F, -5.5F);

        bodyModel[110].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 133
        bodyModel[110].setRotationPoint(-31F, -6F, -6.5F);

        bodyModel[111].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 134
        bodyModel[111].setRotationPoint(-31F, -6F, -2.5F);

        bodyModel[112].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,-1.3F, 9F, -0.6F, 0F, 9F, -0.5F, 0F, 9F, 0F, -1.3F, 9F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0.1F, 0F, 0F, 0F, 0.65F, 0F, 0F); // Box 135
        bodyModel[112].setRotationPoint(-34F, -10F, -8F);

        bodyModel[113].addShapeBox(0F, 0F, 0F, 6, 2, 1, 0F,-3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, -3F, 0F, -0.9F, -3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F); // Box 136
        bodyModel[113].setRotationPoint(-33F, -21F, 2F);

        bodyModel[114].addShapeBox(0F, 0F, 0F, 6, 2, 2, 0F,-3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F); // Box 137
        bodyModel[114].setRotationPoint(-33F, -21F, -2F);

        bodyModel[115].addShapeBox(0F, 0F, 0F, 2, 1, 8, 0F,-1.5F, 0F, -0.01F, 0F, 1F, -0.01F, -1F, 1F, 0F, -0.4F, 0F, 0F, -1.5F, -0.8F, -0.01F, 0F, -0.8F, -0.01F, 0F, -0.8F, 0F, -0.4F, -0.8F, 0F); // Box 139
        bodyModel[115].setRotationPoint(-36F, -7F, -8F);

        bodyModel[116].addShapeBox(0F, 0F, 0F, 0, 6, 7, 0F,-1.5F, 3F, 0F, 1.5F, 3F, 0F, 1.3F, 3F, 0F, -1.3F, 3F, 0F, 1F, 3F, 0F, -1F, 3F, 0F, -0.5F, 3F, 0F, 0.5F, 3F, 0F); // Box 22
        bodyModel[116].setRotationPoint(-34F, -16F, 0F);

        bodyModel[117].addShapeBox(0F, 0F, 0F, 0, 6, 7, 0F,-1.3F, 3F, 0F, 1.3F, 3F, 0F, 1.5F, 3F, 0F, -1.5F, 3F, 0F, 0.5F, 3F, 0F, -0.5F, 3F, 0F, -1F, 3F, 0F, 1F, 3F, 0F); // Box 142
        bodyModel[117].setRotationPoint(-34F, -16F, -7F);

        bodyModel[118].addShapeBox(0F, 0F, 0F, 2, 1, 8, 0F,-0.4F, 0F, 0F, -1F, 1F, 0F, 0F, 1F, -0.01F, -1.5F, 0F, -0.01F, -0.4F, -0.8F, 0F, 0F, -0.8F, 0F, 0F, -0.8F, -0.01F, -1.5F, -0.8F, -0.01F); // Box 134
        bodyModel[118].setRotationPoint(-36F, -7F, 0F);

        bodyModel[119].addShapeBox(0F, 0F, 0F, 1, 2, 16, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Box 119
        bodyModel[119].setRotationPoint(-34F, 3.5F, -8F);

        bodyModel[120].addShapeBox(0F, 0F, 0F, 1, 1, 16, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 1F, 0F, -1F); // Box 120
        bodyModel[120].setRotationPoint(-34F, 5F, -8F);
        this.flipAll();
    }
}