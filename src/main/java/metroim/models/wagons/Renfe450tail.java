...
public class Renfe450tail extends ModelBase //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public Renfe450tail() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[25] = new ModelRendererTurbo(this, 241, 33, textureX, textureY); // Box 41
		bodyModel[26] = new ModelRendererTurbo(this, 257, 33, textureX, textureY); // Box 42
		...
		bodyModel[32] = new ModelRendererTurbo(this, 1, 41, textureX, textureY); // Box 49
		bodyModel[33] = new ModelRendererTurbo(this, 281, 41, textureX, textureY); // Box 50
		...
		bodyModel[0].setRotationPoint(-18F, -11F, -10F);
		...
		bodyModel[1].setRotationPoint(34F, -14F, -9F);
		...
		bodyModel[2].setRotationPoint(34F, -14F, -7F);
		...
		bodyModel[3].setRotationPoint(34F, -14F, 7F);
		...
		bodyModel[4].setRotationPoint(-39F, -16.5F, -8F);
		...
		bodyModel[5].setRotationPoint(-39F, -17F, 8.75F);
		...
		bodyModel[6].setRotationPoint(-39F, -17F, -9.75F);
		...
		bodyModel[7].setRotationPoint(-38F, -14F, -7F);
		...
		bodyModel[8].setRotationPoint(-38F, -14F, -9F);
		...
		bodyModel[9].setRotationPoint(-38F, -14F, 7F);
		...
		bodyModel[10].setRotationPoint(-39F, -10F, -10F);
		...
		bodyModel[11].setRotationPoint(18F, -10F, 9F);

		bodyModel[12].addBox(0F, 0F, 0F, 6, 18, 1, 0F); // Box 16
		bodyModel[12].setRotationPoint(-39F, -7F, -11F);

		bodyModel[13].addBox(0F, 0F, 0F, 36, 7, 1, 0F); // Box 18
		bodyModel[13].setRotationPoint(-18F, -5F, -11F);
		...
		bodyModel[14].setRotationPoint(-39F, 11F, -11F);
		...
		bodyModel[15].setRotationPoint(-39F, 11F, 10F);

		bodyModel[16].addBox(0F, 0F, 0F, 6, 19, 8, 0F); // Box 22
		bodyModel[16].setRotationPoint(-39F, -8F, 3F);
		...
		bodyModel[17].setRotationPoint(-18F, -11F, 9F);
		...
		bodyModel[18].setRotationPoint(-39F, -10F, 9F);

		bodyModel[19].addBox(0F, 0F, 0F, 18, 2, 18, 0F); // Box 25
		bodyModel[19].setRotationPoint(-37F, 9F, -9F);
		...
		bodyModel[20].setRotationPoint(-20F, 12F, -11F);

		bodyModel[21].addBox(0F, 0F, 0F, 5, 18, 3, 0F); // Box 35
		bodyModel[21].setRotationPoint(18F, -7F, -11F);
		...
		bodyModel[22].setRotationPoint(18F, 11F, -11F);
		...
		bodyModel[23].setRotationPoint(18F, 11F, 10F);

		bodyModel[24].addShapeBox(0F, 0F, 0F, 6, 18, 1, 0F,0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F); // Box 39
		bodyModel[24].setRotationPoint(33F, -7F, -11F);

		bodyModel[25].addShapeBox(0F, 0F, 0F, 6, 18, 1, 0F,0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F); // Box 41
		bodyModel[25].setRotationPoint(33F, -7F, 10F);

		bodyModel[26].addBox(0F, 0F, 0F, 5, 18, 3, 0F); // Box 42
		bodyModel[26].setRotationPoint(18F, -7F, 8F);
		...
		bodyModel[27].setRotationPoint(-20F, 12F, 10F);
		...
		bodyModel[28].setRotationPoint(-19F, 13F, -10F);

		bodyModel[29].addBox(0F, 0F, 0F, 36, 6, 1, 0F); // Box 45
		bodyModel[29].setRotationPoint(-18F, 2F, -11F);

		bodyModel[30].addBox(0F, 0F, 0F, 36, 4, 1, 0F); // Box 46
		bodyModel[30].setRotationPoint(-18F, 8F, -11F);

		bodyModel[31].addBox(0F, 0F, 0F, 21, 1, 1, 0F); // Box 48
		bodyModel[31].setRotationPoint(-39F, -8F, -11F);
		...
		bodyModel[32].setRotationPoint(18F, -8F, -11F);
		...
		bodyModel[33].setRotationPoint(18F, -8F, 10F);

		bodyModel[34].addBox(0F, 0F, 0F, 15, 1, 1, 0F); // Box 51
		bodyModel[34].setRotationPoint(-33F, -8F, 10F);

		bodyModel[35].addBox(0F, 0F, 0F, 36, 4, 1, 0F); // Box 52
		bodyModel[35].setRotationPoint(-18F, 8F, 10F);

		bodyModel[36].addBox(0F, 0F, 0F, 36, 6, 1, 0F); // Box 53
		bodyModel[36].setRotationPoint(-18F, 2F, 10F);

		bodyModel[37].addBox(0F, 0F, 0F, 36, 7, 1, 0F); // Box 54
		...
		bodyModel[38].setRotationPoint(-37F, -9F, -9.5F);

		bodyModel[39].addBox(0F, 0F, 0F, 18, 1, 2, 0F); // Box 57
		bodyModel[39].setRotationPoint(-37F, 11F, -10F);

		bodyModel[40].addBox(0F, 0F, 0F, 18, 1, 2, 0F); // Box 58
		bodyModel[40].setRotationPoint(-37F, 11F, 8F);
		...
		bodyModel[41].setRotationPoint(-38F, -10F, -10F);

		bodyModel[42].addBox(0F, 0F, 0F, 1, 1, 6, 0F); // Box 60
		bodyModel[42].setRotationPoint(-38F, 11F, 4F);

		bodyModel[43].addBox(0F, 0F, 0F, 1, 20, 7, 0F); // Box 61
		bodyModel[43].setRotationPoint(-38F, -8F, -10F);

		bodyModel[44].addBox(0F, 0F, 0F, 1, 3, 8, 0F); // Box 62
		bodyModel[44].setRotationPoint(-38F, 9F, -4F);

		bodyModel[45].addBox(0F, 0F, 0F, 1, 17, 6, 0F); // Box 63
		bodyModel[45].setRotationPoint(-38F, -8F, -3F);
		...
		bodyModel[46].setRotationPoint(18F, -11F, -10F);
		...
		bodyModel[47].setRotationPoint(18F, -14F, -9F);
		...
		bodyModel[48].setRotationPoint(18F, -11F, 8F);
		...
		bodyModel[49].setRotationPoint(18F, -14F, 8F);

		bodyModel[50].addShapeBox(0F, 0F, 0F, 1, 20, 7, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 68
		bodyModel[50].setRotationPoint(34F, -8F, -10F);

		bodyModel[51].addBox(0F, 0F, 0F, 1, 20, 7, 0F); // Box 70
		bodyModel[51].setRotationPoint(34F, -8F, 3F);

		bodyModel[52].addBox(0F, 0F, 0F, 1, 3, 6, 0F); // Box 71
		bodyModel[52].setRotationPoint(34F, 9F, -3F);
		...
		bodyModel[53].setRotationPoint(34F, -10F, -10F);

		bodyModel[54].addBox(0F, 0F, 0F, 32, 1, 20, 0F); // Box 73
		bodyModel[54].setRotationPoint(-16F, 0F, -10F);

		bodyModel[55].addBox(0F, 0F, 0F, 5, 18, 3, 0F); // Box 74
		bodyModel[55].setRotationPoint(-23F, -7F, 8F);
		...
		bodyModel[56].setRotationPoint(-23F, -11F, 8F);
		...
		bodyModel[57].setRotationPoint(-23F, -14F, 8F);

		bodyModel[58].addBox(0F, 0F, 0F, 5, 18, 3, 0F); // Box 77
		bodyModel[58].setRotationPoint(-23F, -7F, -11F);
		...
		bodyModel[59].setRotationPoint(-23F, -11F, -10F);
		...
		bodyModel[60].setRotationPoint(-23F, -14F, -9F);

		bodyModel[61].addBox(0F, 0F, 0F, 1, 4, 8, 0F); // Box 80
		bodyModel[61].setRotationPoint(18F, 9F, -8F);

		bodyModel[62].addBox(0F, 0F, 0F, 2, 2, 8, 0F); // Box 81
		bodyModel[62].setRotationPoint(17F, 11F, 0F);

		bodyModel[63].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 82
		bodyModel[63].setRotationPoint(18F, 11F, 8F);

		bodyModel[64].addBox(0F, 0F, 0F, 1, 4, 8, 0F); // Box 84
		bodyModel[64].setRotationPoint(-19F, 9F, -8F);

		bodyModel[65].addBox(0F, 0F, 0F, 2, 2, 8, 0F); // Box 85
		bodyModel[65].setRotationPoint(-19F, 11F, 0F);
		...
		bodyModel[66].setRotationPoint(-19F, 3F, -8F);

		bodyModel[67].addBox(0F, 0F, 0F, 4, 2, 8, 0F); // Box 87
		bodyModel[67].setRotationPoint(-22F, 7F, -8F);
		...
		bodyModel[68].setRotationPoint(-20F, 5F, -8F);

		bodyModel[69].addBox(0F, 0F, 0F, 15, 2, 18, 0F); // Box 89
		bodyModel[69].setRotationPoint(19F, 9F, -9F);

		bodyModel[70].addBox(0F, 0F, 0F, 18, 1, 2, 0F); // Box 90
		bodyModel[70].setRotationPoint(19F, 11F, 8F);

		bodyModel[71].addBox(0F, 0F, 0F, 18, 1, 2, 0F); // Box 91
		bodyModel[71].setRotationPoint(19F, 11F, -10F);

		bodyModel[72].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 92
		bodyModel[72].setRotationPoint(-19F, 11F, -10F);

		bodyModel[73].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 93
		bodyModel[73].setRotationPoint(18F, 11F, -10F);
		...
		bodyModel[74].setRotationPoint(-17.5F, 1F, -8F);
		...
		bodyModel[75].setRotationPoint(-18F, 0F, -10F);

		bodyModel[76].addBox(0F, 0F, 0F, 4, 2, 8, 0F); // Box 97
		bodyModel[76].setRotationPoint(18F, 7F, -8F);
		...
		bodyModel[77].setRotationPoint(18.5F, 5F, -8F);
		...
		bodyModel[78].setRotationPoint(17F, 3F, -8F);
		...
		bodyModel[79].setRotationPoint(15.5F, 1F, -8F);
		...
		bodyModel[81].setRotationPoint(16F, -11F, -10F);
		...
		bodyModel[82].setRotationPoint(16F, -14F, -9F);

		bodyModel[83].addBox(0F, 0F, 0F, 2, 7, 2, 0F); // Box 104
		bodyModel[83].setRotationPoint(16F, -7F, -10F);
		...
		bodyModel[84].setRotationPoint(-18F, -11F, -10F);
		...
		bodyModel[85].setRotationPoint(-18F, -14F, -9F);

		bodyModel[86].addBox(0F, 0F, 0F, 2, 7, 2, 0F); // Box 107
		bodyModel[86].setRotationPoint(-18F, -7F, -10F);
		...
		bodyModel[87].setRotationPoint(-18F, -11F, 8F);
		...
		bodyModel[88].setRotationPoint(-18F, -14F, 8F);

		bodyModel[89].addBox(0F, 0F, 0F, 2, 20, 2, 0F); // Box 110
		bodyModel[89].setRotationPoint(-18F, -7F, 8F);
		...
		bodyModel[90].setRotationPoint(16F, -14F, 8F);
		...
		bodyModel[91].setRotationPoint(16F, -11F, 8F);
		...
		bodyModel[92].setRotationPoint(-17.25F, 9F, -14F);
		...
		bodyModel[93].setRotationPoint(-18F, 10F, -10F);
		...
		bodyModel[94].setRotationPoint(-18F, 10F, -7.5F);
		...
		bodyModel[95].setRotationPoint(-18.3F, 4.9F, -14F);
		...
		bodyModel[96].setRotationPoint(-17.9F, 6F, -10F);
		...
		bodyModel[97].setRotationPoint(-18F, 4.8F, -10F);
		...
		bodyModel[98].setRotationPoint(-17.9F, 6F, -7.5F);
		...
		bodyModel[99].setRotationPoint(-18.3F, 4.9F, -9.5F);
		...
		bodyModel[100].setRotationPoint(-17.25F, 9F, -9.5F);
		...
		bodyModel[101].setRotationPoint(-18F, 10F, -3F);
		...
		bodyModel[102].setRotationPoint(-18F, 10F, -5.5F);
		...
		bodyModel[103].setRotationPoint(-17.9F, 6F, -3F);
		...
		bodyModel[104].setRotationPoint(-17.9F, 6F, -5.5F);
		...
		bodyModel[105].setRotationPoint(-18F, 4.8F, -5.5F);
		...
		bodyModel[106].setRotationPoint(-10.5F, 9F, -9.5F);
		...
		bodyModel[107].setRotationPoint(-10.5F, 9F, -14F);
		...
		bodyModel[108].setRotationPoint(-7.45F, 4.9F, -14F);
		...
		bodyModel[109].setRotationPoint(-7.75F, 10F, -7.5F);
		...
		bodyModel[110].setRotationPoint(-7.75F, 10F, -10F);
		...
		bodyModel[111].setRotationPoint(-7.85F, 6F, -10F);
		...
		bodyModel[112].setRotationPoint(-7.85F, 6F, -7.5F);
		...
		bodyModel[113].setRotationPoint(-7.75F, 4.8F, -10F);
		...
		bodyModel[114].setRotationPoint(-7.45F, 4.9F, -9.5F);
		...
		bodyModel[115].setRotationPoint(-7.85F, 6F, -3F);
		...
		bodyModel[116].setRotationPoint(-7.85F, 6F, -5.5F);
		...
		bodyModel[117].setRotationPoint(-7.75F, 4.8F, -5.5F);
		...
		bodyModel[118].setRotationPoint(-7.75F, 10F, -3F);
		...
		bodyModel[119].setRotationPoint(-7.75F, 10F, -5.5F);
		...
		bodyModel[120].setRotationPoint(4.8F, 4.9F, -9.5F);
		...
		bodyModel[121].setRotationPoint(4.40000000000001F, 6F, -3F);
		...
		bodyModel[122].setRotationPoint(4.40000000000001F, 6F, -5.5F);
		...
		bodyModel[123].setRotationPoint(4.5F, 4.8F, -5.5F);
		...
		bodyModel[124].setRotationPoint(4.5F, 10F, -3F);
		...
		bodyModel[125].setRotationPoint(4.5F, 10F, -5.5F);
		...
		bodyModel[126].setRotationPoint(1.75F, 9F, -9.5F);
		...
		bodyModel[127].setRotationPoint(1.75F, 9F, -14F);
		...
		bodyModel[128].setRotationPoint(4.5F, 10F, -10F);
		...
		bodyModel[129].setRotationPoint(4.5F, 10F, -7.5F);
		...
		bodyModel[130].setRotationPoint(4.8F, 4.9F, -14F);
		...
		bodyModel[131].setRotationPoint(4.40000000000001F, 6F, -7.5F);
		...
		bodyModel[132].setRotationPoint(4.40000000000001F, 6F, -10F);
		...
		bodyModel[133].setRotationPoint(4.5F, 4.8F, -10F);
		...
		bodyModel[134].setRotationPoint(-5.5F, 9F, -14F);
		...
		bodyModel[135].setRotationPoint(-6.25F, 10F, -5.5F);
		...
		bodyModel[136].setRotationPoint(-6.55F, 4.9F, -9.5F);
		...
		bodyModel[137].setRotationPoint(-5.5F, 9F, -9.5F);
		...
		bodyModel[138].setRotationPoint(-6.25F, 10F, -3F);
		...
		bodyModel[139].setRotationPoint(-6.15F, 6F, -10F);
		...
		bodyModel[140].setRotationPoint(-6.55F, 4.9F, -14F);
		...
		bodyModel[141].setRotationPoint(-6.25F, 4.8F, -10F);
		...
		bodyModel[142].setRotationPoint(-6.15F, 6F, -7.5F);
		...
		bodyModel[143].setRotationPoint(-6.15F, 6F, -5.5F);
		...
		bodyModel[144].setRotationPoint(-6.15F, 6F, -3F);
		...
		bodyModel[145].setRotationPoint(-6.25F, 4.8F, -5.5F);
		...
		bodyModel[146].setRotationPoint(16.8F, 4.9F, -9.5F);
		...
		bodyModel[147].setRotationPoint(16.4F, 6F, -3F);
		...
		bodyModel[148].setRotationPoint(16.4F, 6F, -5.5F);
		...
		bodyModel[149].setRotationPoint(16.5F, 4.8F, -5.5F);
		...
		bodyModel[150].setRotationPoint(16.5F, 10F, -3F);
		...
		bodyModel[151].setRotationPoint(16.5F, 10F, -5.5F);
		...
		bodyModel[152].setRotationPoint(13.75F, 9F, -9.5F);
		...
		bodyModel[153].setRotationPoint(13.75F, 9F, -14F);
		...
		bodyModel[154].setRotationPoint(16.5F, 10F, -10F);
		...
		bodyModel[155].setRotationPoint(16.5F, 10F, -7.5F);
		...
		bodyModel[156].setRotationPoint(16.8F, 4.9F, -14F);
		...
		bodyModel[157].setRotationPoint(16.4F, 6F, -7.5F);
		...
		bodyModel[158].setRotationPoint(16.4F, 6F, -10F);
		...
		bodyModel[159].setRotationPoint(16.5F, 4.8F, -10F);
		...
		bodyModel[160].setRotationPoint(6.75F, 9F, -14F);
		...
		bodyModel[161].setRotationPoint(6F, 10F, -5.5F);
		...
		bodyModel[162].setRotationPoint(5.7F, 4.9F, -9.5F);
		...
		bodyModel[163].setRotationPoint(6.75F, 9F, -9.5F);
		...
		bodyModel[164].setRotationPoint(6F, 10F, -3F);
		...
		bodyModel[165].setRotationPoint(6.1F, 6F, -10F);
		...
		bodyModel[166].setRotationPoint(5.7F, 4.9F, -14F);
		...
		bodyModel[167].setRotationPoint(6F, 4.8F, -10F);
		...
		bodyModel[168].setRotationPoint(6.1F, 6F, -7.5F);
		...
		bodyModel[169].setRotationPoint(6.1F, 6F, -5.5F);
		...
		bodyModel[170].setRotationPoint(6.1F, 6F, -3F);
		...
		bodyModel[171].setRotationPoint(6F, 4.8F, -5.5F);
		...
		bodyModel[172].setRotationPoint(6F, 10F, -10F);
		...
		bodyModel[173].setRotationPoint(6F, 10F, -7.5F);
		...
		bodyModel[174].setRotationPoint(-6.25F, 10F, -10F);
		...
		bodyModel[175].setRotationPoint(-6.25F, 10F, -7.5F);
		...
		bodyModel[176].setRotationPoint(-16.3F, -8.1F, 1.5F);
		...
		bodyModel[177].setRotationPoint(-15.25F, -4F, 1.5F);
		...
		bodyModel[178].setRotationPoint(-16F, -3F, 8F);
		...
		bodyModel[179].setRotationPoint(-16F, -3F, 5.5F);
		...
		bodyModel[180].setRotationPoint(-15.9F, -7F, 8F);
		...
		bodyModel[181].setRotationPoint(-15.9F, -7F, 5.5F);
		...
		bodyModel[182].setRotationPoint(-16F, -8.2F, 5.5F);
		...
		bodyModel[183].setRotationPoint(-9.5F, -4F, 1.5F);
		...
		bodyModel[184].setRotationPoint(-6.45F, -8.1F, 1.5F);
		...
		bodyModel[185].setRotationPoint(-6.85F, -7F, 8F);
		...
		bodyModel[186].setRotationPoint(-6.85F, -7F, 5.5F);
		...
		bodyModel[187].setRotationPoint(-6.75F, -8.2F, 5.5F);
		...
		bodyModel[188].setRotationPoint(-6.75F, -3F, 8F);
		...
		bodyModel[189].setRotationPoint(-6.75F, -3F, 5.5F);
		...
		bodyModel[190].setRotationPoint(6.75F, -4F, 1.5F);
		...
		bodyModel[191].setRotationPoint(6F, -3F, 5.5F);
		...
		bodyModel[192].setRotationPoint(6F, -3F, 8F);
		...
		bodyModel[193].setRotationPoint(5.7F, -8.1F, 1.5F);
		...
		bodyModel[194].setRotationPoint(6F, -8.2F, 5.5F);
		...
		bodyModel[195].setRotationPoint(6.1F, -7F, 5.5F);
		...
		bodyModel[196].setRotationPoint(6.1F, -7F, 8F);
		...
		bodyModel[197].setRotationPoint(12.5F, -4F, 1.5F);
		...
		bodyModel[198].setRotationPoint(15.55F, -8.1F, 1.5F);
		...
		bodyModel[199].setRotationPoint(15.25F, -3F, 5.5F);
		...
		bodyModel[200].setRotationPoint(15.25F, -3F, 8F);
		...
		bodyModel[201].setRotationPoint(15.15F, -7F, 5.5F);
		...
		bodyModel[202].setRotationPoint(15.15F, -7F, 8F);
		...
		bodyModel[203].setRotationPoint(15.25F, -8.2F, 5.5F);
		...
		bodyModel[204].setRotationPoint(4.75F, -3F, 5.5F);
		...
		bodyModel[205].setRotationPoint(4.75F, -3F, 8F);
		...
		bodyModel[206].setRotationPoint(5.05F, -8.1F, 1.5F);
		...
		bodyModel[207].setRotationPoint(4.75F, -8.2F, 5.5F);
		...
		bodyModel[208].setRotationPoint(4.65F, -7F, 5.5F);
		...
		bodyModel[209].setRotationPoint(4.65F, -7F, 8F);
		...
		bodyModel[210].setRotationPoint(2F, -4F, 1.5F);
		...
		bodyModel[211].setRotationPoint(-5.5F, -3F, 8F);
		...
		bodyModel[212].setRotationPoint(-4.75F, -4F, 1.5F);
		...
		bodyModel[213].setRotationPoint(-5.5F, -3F, 5.5F);
		...
		bodyModel[214].setRotationPoint(-5.8F, -8.1F, 1.5F);
		...
		bodyModel[215].setRotationPoint(-5.4F, -7F, 5.5F);
		...
		bodyModel[216].setRotationPoint(-5.4F, -7F, 8F);
		...
		bodyModel[217].setRotationPoint(-5.5F, -8.2F, 5.5F);
		...
		bodyModel[218].setRotationPoint(5F, 1F, 6F);
		...
		bodyModel[219].setRotationPoint(5F, 2F, 8.97F);
		...
		bodyModel[220].setRotationPoint(-23F, -9F, -8F);

		bodyModel[221].addBox(0F, 0F, 0F, 10, 2, 1, 0F); // Box 276
		bodyModel[221].setRotationPoint(-33F, -8F, -10F);
		...
		bodyModel[222].setRotationPoint(-33F, -8F, -9F);
		...
		bodyModel[223].setRotationPoint(23F, -8F, -9F);

		bodyModel[224].addBox(0F, 0F, 0F, 10, 2, 1, 0F); // Box 279
		bodyModel[224].setRotationPoint(23F, -8F, -10F);
		...
		bodyModel[225].setRotationPoint(23F, -9F, -9.5F);
		...
		bodyModel[226].setRotationPoint(18F, -9F, -8F);
		...
		bodyModel[227].setRotationPoint(18F, -14F, -7.5F);
		...
		bodyModel[228].setRotationPoint(17F, -7F, 0F);

		bodyModel[229].addBox(0F, 0F, 0F, 1, 8, 8, 0F); // Box 284
		bodyModel[229].setRotationPoint(16F, -7F, 0F);
		...
		bodyModel[230].setRotationPoint(-39F, -16.5F, -1F);
		...
		bodyModel[231].setRotationPoint(-39F, -16.5F, -4F);
		...
		bodyModel[232].setRotationPoint(-38F, -15.5F, -7F);
		...
		bodyModel[233].setRotationPoint(34F, -15.5F, -7F);
		...
		bodyModel[234].setRotationPoint(-23F, -7F, 0F);

		bodyModel[235].addBox(0F, 0F, 0F, 1, 8, 8, 0F); // Box 290
		bodyModel[235].setRotationPoint(-17F, -7F, 0F);
		...
		bodyModel[236].setRotationPoint(18F, -15.5F, -7F);
		...
		bodyModel[237].setRotationPoint(-19F, -14F, -7.5F);
		...
		bodyModel[238].setRotationPoint(-19F, -15.5F, -7F);
		...
		bodyModel[239].setRotationPoint(5F, -14F, 7.97F);
		...
		bodyModel[240].setRotationPoint(5F, -11F, 7.97F);
		...
		bodyModel[241].setRotationPoint(5F, -14F, 3.47F);

		bodyModel[242].addBox(0F, 0F, 0F, 2, 17, 1, 0F); // Box 301
		bodyModel[242].setRotationPoint(-40F, -8F, -4F);

		bodyModel[243].addBox(0F, 0F, 0F, 2, 1, 8, 0F); // Box 302
		bodyModel[243].setRotationPoint(-40F, 9F, -4F);

		bodyModel[244].addBox(0F, 0F, 0F, 1, 17, 1, 0F); // Box 303
		bodyModel[244].setRotationPoint(-40F, -8F, 3F);

		bodyModel[245].addBox(0F, 0F, 0F, 2, 1, 8, 0F); // Box 304
		bodyModel[245].setRotationPoint(-40F, -9F, -4F);
		...
		bodyModel[246].setRotationPoint(-18F, -14F, 3.5F);
		...
		bodyModel[247].setRotationPoint(16F, -14F, 3.47F);
		...
		bodyModel[248].setRotationPoint(5F, -11F, -9.97F);
		...
		bodyModel[249].setRotationPoint(5F, -14F, -8.97F);
		...
		bodyModel[250].setRotationPoint(5F, -14F, -6.47F);

		bodyModel[251].addBox(0F, 0F, 0F, 2, 6, 2, 0F); // Box 312
		bodyModel[251].setRotationPoint(5F, -5F, -10.97F);
		...
		bodyModel[253].setRotationPoint(5F, 2F, -10.97F);
		...
		bodyModel[254].setRotationPoint(5F, 1F, -10F);
		...
		bodyModel[256].setRotationPoint(-6.55F, 4.9F, 1.5F);
		...
		bodyModel[257].setRotationPoint(-10.5F, 9F, 1.5F);
		...
		bodyModel[258].setRotationPoint(-7.75F, 10F, 8F);
		...
		bodyModel[259].setRotationPoint(-6.25F, 10F, 8F);
		...
		bodyModel[260].setRotationPoint(-6.25F, 10F, 5.5F);
		...
		bodyModel[261].setRotationPoint(-5.5F, 9F, 1.5F);
		...
		bodyModel[262].setRotationPoint(-6.15F, 6F, 8F);
		...
		bodyModel[263].setRotationPoint(-7.85F, 6F, 8F);
		...
		bodyModel[264].setRotationPoint(-7.45F, 4.9F, 1.5F);
		...
		bodyModel[265].setRotationPoint(-7.75F, 4.8F, 5.5F);
		...
		bodyModel[266].setRotationPoint(-7.85F, 6F, 5.5F);
		...
		bodyModel[267].setRotationPoint(-6.15F, 6F, 5.5F);
		...
		bodyModel[268].setRotationPoint(-6.25F, 4.8F, 5.5F);
		...
		bodyModel[269].setRotationPoint(-7.75F, 10F, 5.5F);
		...
		bodyModel[270].setRotationPoint(5.75F, 4.9F, 1.5F);
		...
		bodyModel[271].setRotationPoint(1.8F, 9F, 1.5F);
		...
		bodyModel[272].setRotationPoint(4.55F, 10F, 8F);
		...
		bodyModel[273].setRotationPoint(6.05F, 10F, 8F);
		...
		bodyModel[274].setRotationPoint(6.05F, 10F, 5.5F);
		...
		bodyModel[275].setRotationPoint(6.8F, 9F, 1.5F);
		...
		bodyModel[276].setRotationPoint(6.15F, 6F, 8F);
		...
		bodyModel[277].setRotationPoint(4.45F, 6F, 8F);
		...
		bodyModel[278].setRotationPoint(4.85F, 4.9F, 1.5F);
		...
		bodyModel[279].setRotationPoint(4.55F, 4.8F, 5.5F);
		...
		bodyModel[280].setRotationPoint(4.45F, 6F, 5.5F);
		...
		bodyModel[281].setRotationPoint(6.15F, 6F, 5.5F);
		...
		bodyModel[282].setRotationPoint(6.05F, 4.8F, 5.5F);
		...
		bodyModel[283].setRotationPoint(4.55F, 10F, 5.5F);
		...
		bodyModel[284].setRotationPoint(6F, -8.1F, -13F);
		...
		bodyModel[285].setRotationPoint(2.05F, -4F, -13F);
		...
		bodyModel[286].setRotationPoint(4.8F, -3F, -6.5F);
		...
		bodyModel[287].setRotationPoint(6.3F, -3F, -6.5F);
		...
		bodyModel[288].setRotationPoint(6.3F, -3F, -9F);
		...
		bodyModel[289].setRotationPoint(7.05F, -4F, -13F);
		...
		bodyModel[290].setRotationPoint(6.4F, -7F, -6.5F);
		...
		bodyModel[291].setRotationPoint(4.7F, -7F, -6.5F);
		...
		bodyModel[292].setRotationPoint(5.1F, -8.1F, -13F);
		...
		bodyModel[293].setRotationPoint(4.8F, -8.2F, -9F);
		...
		bodyModel[294].setRotationPoint(4.7F, -7F, -9F);
		...
		bodyModel[295].setRotationPoint(6.4F, -7F, -9F);
		...
		bodyModel[296].setRotationPoint(6.3F, -8.2F, -9F);
		...
		bodyModel[297].setRotationPoint(4.8F, -3F, -9F);
		...
		bodyModel[298].setRotationPoint(-5.75F, -8.1F, -13F);
		...
		bodyModel[299].setRotationPoint(-9.7F, -4F, -13F);
		...
		bodyModel[300].setRotationPoint(-6.95F, -3F, -6.5F);
		...
		bodyModel[301].setRotationPoint(-5.45F, -3F, -6.5F);
		...
		bodyModel[302].setRotationPoint(-5.45F, -3F, -9F);
		...
		bodyModel[303].setRotationPoint(-4.7F, -4F, -13F);
		...
		bodyModel[304].setRotationPoint(-5.35F, -7F, -6.5F);
		...
		bodyModel[305].setRotationPoint(-7.05F, -7F, -6.5F);
		...
		bodyModel[306].setRotationPoint(-6.65F, -8.1F, -13F);
		...
		bodyModel[307].setRotationPoint(-6.95F, -8.2F, -9F);
		...
		bodyModel[308].setRotationPoint(-7.05F, -7F, -9F);
		...
		bodyModel[309].setRotationPoint(-5.35F, -7F, -9F);
		...
		bodyModel[310].setRotationPoint(-5.45F, -8.2F, -9F);
		...
		bodyModel[311].setRotationPoint(-6.95F, -3F, -9F);

		bodyModel[312].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 373
		bodyModel[312].setRotationPoint(23F, -7F, 10F);

		bodyModel[313].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 374
		bodyModel[313].setRotationPoint(28F, -7F, 10F);

		bodyModel[314].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 375
		bodyModel[314].setRotationPoint(-33F, -7F, 10F);

		bodyModel[315].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 376
		bodyModel[315].setRotationPoint(-28F, -7F, 10F);

		bodyModel[316].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 377
		bodyModel[316].setRotationPoint(-33F, -7F, -11F);

		bodyModel[317].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 378
		bodyModel[317].setRotationPoint(-28F, -7F, -11F);

		bodyModel[318].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 379
		bodyModel[318].setRotationPoint(23F, -7F, -11F);

		bodyModel[319].addBox(0F, 0F, 0F, 5, 18, 1, 0F); // Box 380
		bodyModel[319].setRotationPoint(28F, -7F, -11F);

		bodyModel[320].addBox(0F, 0F, 0F, 2, 2, 2, 0F); // Box 381
		bodyModel[320].setRotationPoint(-40F, 8F, -9F);

		bodyModel[321].addBox(0F, 0F, 0F, 2, 2, 2, 0F); // Box 382
		bodyModel[321].setRotationPoint(-40F, 8F, 7F);

		bodyModel[322].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Box 385
		bodyModel[322].setRotationPoint(-40F, 10F, -1F);
		...
		bodyModel[324].setRotationPoint(-7F, 2F, -10.97F);
		...
		bodyModel[325].setRotationPoint(-7F, 1F, -10F);
		...
		bodyModel[326].setRotationPoint(-7F, 2F, 8.97F);
		...
		bodyModel[328].setRotationPoint(-7F, 1F, 6F);
		...
		bodyModel[329].setRotationPoint(-7F, 2F, 8.97F);
		...
		bodyModel[331].setRotationPoint(-7F, -11F, 7.97F);
		...
		bodyModel[332].setRotationPoint(-7F, -14F, 7.97F);
		...
		bodyModel[333].setRotationPoint(-7F, -14F, 3.47F);
		...
		bodyModel[334].setRotationPoint(5.05F, -8.1F, -3F);
		...
		bodyModel[335].setRotationPoint(5.7F, -8.1F, -3F);
		...
		bodyModel[336].setRotationPoint(4.75F, -3F, 1F);
		...
		bodyModel[337].setRotationPoint(4.75F, -3F, 3.5F);
		...
		bodyModel[338].setRotationPoint(6F, -3F, 3.5F);
		...
		bodyModel[339].setRotationPoint(6F, -3F, 1F);
		...
		bodyModel[340].setRotationPoint(6.75F, -4F, -3F);
		...
		bodyModel[341].setRotationPoint(2F, -4F, -3F);
		...
		bodyModel[342].setRotationPoint(6.1F, -7F, 1F);
		...
		bodyModel[343].setRotationPoint(4.65F, -7F, 1F);
		...
		bodyModel[344].setRotationPoint(6.1F, -7F, 3.5F);
		...
		bodyModel[345].setRotationPoint(4.65F, -7F, 3.5F);
		...
		bodyModel[346].setRotationPoint(6F, -8.2F, 1F);
		...
		bodyModel[347].setRotationPoint(4.75F, -8.2F, 1F);
		...
		bodyModel[348].setRotationPoint(12.5F, -4F, -3F);
		...
		bodyModel[349].setRotationPoint(15.55F, -8.1F, -3F);
		...
		bodyModel[350].setRotationPoint(15.25F, -8.2F, 1F);
		...
		bodyModel[351].setRotationPoint(15.25F, -3F, 1F);
		...
		bodyModel[352].setRotationPoint(15.15F, -7F, 1F);
		...
		bodyModel[353].setRotationPoint(15.15F, -7F, 3.5F);
		...
		bodyModel[354].setRotationPoint(15.25F, -3F, 3.5F);
		...
		bodyModel[355].setRotationPoint(-4.75F, -4F, -3F);
		...
		bodyModel[356].setRotationPoint(-6.75F, -3F, 1F);
		...
		bodyModel[357].setRotationPoint(-9.5F, -4F, -3F);
		...
		bodyModel[358].setRotationPoint(-6.45F, -8.1F, -3F);
		...
		bodyModel[359].setRotationPoint(-5.8F, -8.1F, -3F);
		...
		bodyModel[360].setRotationPoint(-5.5F, -3F, 3.5F);
		...
		bodyModel[361].setRotationPoint(-5.5F, -3F, 1F);
		...
		bodyModel[362].setRotationPoint(-6.75F, -3F, 3.5F);
		...
		bodyModel[363].setRotationPoint(-6.85F, -7F, 1F);
		...
		bodyModel[364].setRotationPoint(-6.85F, -7F, 3.5F);
		...
		bodyModel[365].setRotationPoint(-6.75F, -8.2F, 1F);
		...
		bodyModel[366].setRotationPoint(-5.4F, -7F, 1F);
		...
		bodyModel[367].setRotationPoint(-5.4F, -7F, 3.5F);
		...
		bodyModel[368].setRotationPoint(-5.5F, -8.2F, 1F);
		...
		bodyModel[369].setRotationPoint(-15.25F, -4F, -3F);
		...
		bodyModel[370].setRotationPoint(-16F, -3F, 1F);
		...
		bodyModel[371].setRotationPoint(-16F, -3F, 3.5F);
		...
		bodyModel[372].setRotationPoint(-16.3F, -8.1F, -3F);
		...
		bodyModel[373].setRotationPoint(-15.9F, -7F, 1F);
		...
		bodyModel[374].setRotationPoint(-15.9F, -7F, 3.5F);
		...
		bodyModel[375].setRotationPoint(-16F, -8.2F, 1F);

		bodyModel[376].addBox(0F, 0F, 0F, 2, 6, 2, 0F); // Box 386
		bodyModel[376].setRotationPoint(-7F, -5F, -10.97F);
		...
		bodyModel[377].setRotationPoint(-7F, -11F, -9.97F);
		...
		bodyModel[378].setRotationPoint(-7F, -14F, -8.97F);
		...
		bodyModel[379].setRotationPoint(-7F, -14F, -6.47F);
		...
		bodyModel[380].setRotationPoint(16F, -14F, -6.47F);
		...
		bodyModel[381].setRotationPoint(-18F, -14F, -6.47F);

		bodyModel[382].addBox(0F, 0F, 0F, 2, 6, 2, 0F); // Box 392
		bodyModel[382].setRotationPoint(-7F, -5F, 8.97F);

		bodyModel[383].addBox(0F, 0F, 0F, 2, 6, 2, 0F); // Box 393
		bodyModel[383].setRotationPoint(5F, -5F, 8.97F);

		bodyModel[384].addBox(0F, 0F, 0F, 2, 20, 2, 0F); // Box 394
		bodyModel[384].setRotationPoint(16F, -7F, 8F);

		bodyModel[385].addBox(0F, 0F, 0F, 1, 17, 6, 0F); // Box 395
		bodyModel[385].setRotationPoint(34F, -8F, -3F);

		bodyModel[386].addBox(0F, 0F, 0F, 4, 21, 1, 0F); // Box 394
		bodyModel[386].setRotationPoint(37F, -8F, 10F);

		bodyModel[387].addBox(0F, 0F, 0F, 4, 21, 1, 0F); // Box 395
		bodyModel[387].setRotationPoint(37F, -8F, -11F);

		bodyModel[388].addShapeBox(0F, 0F, 0F, 4, 15, 1, 0F,0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 2F, 0F, -1F, 2F, 0F, 1F, 0F, 0F, 0F); // Box 396
		bodyModel[388].setRotationPoint(41F, -8F, -11F);
		...
		bodyModel[389].setRotationPoint(45F, 7F, 4.5F);
		...
		bodyModel[390].setRotationPoint(48F, 6.9F, 5F);
		...
		bodyModel[391].setRotationPoint(47.3F, 6.9F, -8.5F);
		...
		bodyModel[392].setRotationPoint(45F, 7F, -10.5F);
		...
		bodyModel[393].setRotationPoint(42F, 7F, 10.5F);
		...
		bodyModel[394].setRotationPoint(42F, 7F, -11.5F);
		...
		bodyModel[395].setRotationPoint(45F, 10F, -9.5F);
		...
		bodyModel[396].setRotationPoint(41F, 10F, 9F);
		...
		bodyModel[397].setRotationPoint(41F, 10F, -10F);

		bodyModel[398].addShapeBox(0F, 0F, 0F, 4, 15, 1, 0F,0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 2F, 0F, 1F, 2F, 0F, -1F, 0F, 0F, 0F); // Box 407
		bodyModel[398].setRotationPoint(41F, -8F, 10F);
		...
		bodyModel[399].setRotationPoint(18F, -10F, -10F);

		bodyModel[400].addShapeBox(0F, 0F, 0F, 1, 18, 18, 0F,2F, 0F, 0.1F, -2.4F, 0F, 0F, -2.4F, 0F, 0F, 2F, 0F, 0.1F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F); // Box 409
		bodyModel[400].setRotationPoint(46F, -11F, -9F);

		bodyModel[401].addShapeBox(0F, 0F, 0F, 1, 2, 4, 0F,0F, -0.2F, -1.2F, -0.7F, -0.2F, -1.2F, -0.7F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, 0F, -1.2F, -0.5F, 0F, -1.2F, -0.5F, 0F, 0F, 0F, 0F, 0F); // Box 410
		bodyModel[401].setRotationPoint(46.6F, 4.5F, 4F);

		bodyModel[402].addShapeBox(0F, 0F, 0F, 1, 2, 4, 0F,0F, -0.2F, -0.2F, -0.7F, -0.2F, -0.2F, -0.7F, -0.2F, -1F, 0F, -0.2F, -1F, 0F, 0F, -0.2F, -0.5F, 0F, -0.2F, -0.5F, 0F, -1F, 0F, 0F, -1F); // Box 411
		bodyModel[402].setRotationPoint(46.6F, 4.5F, -8F);
		...
		bodyModel[403].setRotationPoint(41F, -11F, 10F);
		...
		bodyModel[404].setRotationPoint(41F, -11F, -11F);
		...
		bodyModel[405].setRotationPoint(37F, -17F, -9.75F);
		...
		bodyModel[406].setRotationPoint(37F, -17F, 8.75F);
		...
		bodyModel[407].setRotationPoint(35F, 9F, -9F);
		...
		bodyModel[408].setRotationPoint(44.6F, -12F, -4F);
		...
		bodyModel[409].setRotationPoint(41F, -17F, 8.75F);
		...
		bodyModel[410].setRotationPoint(41F, -17F, -9.75F);
		...
		bodyModel[411].setRotationPoint(45F, 10F, 4.5F);
		...
		bodyModel[412].setRotationPoint(42F, 10.2F, 0F);
		...
		bodyModel[413].setRotationPoint(42F, 10.2F, -0.75F);
		...
		bodyModel[414].setRotationPoint(42F, 9.45F, -0.75F);
		...
		bodyModel[415].setRotationPoint(42F, 9.45F, 0F);

		bodyModel[416].addBox(0F, 0F, 0F, 1, 2, 4, 0F); // Box 337
		bodyModel[416].setRotationPoint(47.7F, 9.2F, -2F);
		...
		bodyModel[417].setRotationPoint(48.2F, 9.7F, 0.199999999999999F);

		bodyModel[418].addBox(0F, 0F, 0F, 1, 1, 4, 0F); // Box 339
		bodyModel[418].setRotationPoint(47.7F, 7.7F, -2F);
		...
		bodyModel[419].setRotationPoint(34.7F, 9.5F, -1.5F);
		...
		bodyModel[420].setRotationPoint(48F, 8F, 1.4F);
		...
		bodyModel[421].setRotationPoint(48F, 8F, -3F);
		...
		bodyModel[422].setRotationPoint(34.7F, 9.5F, 1.5F);
		...
		bodyModel[423].setRotationPoint(38F, 7F, -9F);
		...
		bodyModel[424].setRotationPoint(43.6F, -14F, -9F);

		bodyModel[425].addBox(0F, 0F, 0F, 1, 1, 5, 0F); // Box 429
		bodyModel[425].setRotationPoint(46F, 7F, -9F);

		bodyModel[426].addBox(0F, 0F, 0F, 1, 1, 5, 0F); // Box 430
		bodyModel[426].setRotationPoint(46F, 7F, 4F);
		...
		bodyModel[427].setRotationPoint(41F, 7F, -11F);
		...
		bodyModel[428].setRotationPoint(41F, 7F, 10F);
		...
		bodyModel[429].setRotationPoint(37F, -15.5F, -8F);

		bodyModel[430].addShapeBox(0F, 0F, 0F, 1, 2, 8, 0F,-1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, 1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 430
		bodyModel[430].setRotationPoint(45.5F, 12.5F, 0F);

		bodyModel[431].addShapeBox(0F, 0F, 0F, 1, 2, 8, 0F,0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1.5F, 0F, 0F, -2F, 0F, 0F); // Box 431
		bodyModel[431].setRotationPoint(45.5F, 12.5F, -8F);
		...
		bodyModel[432].setRotationPoint(42.5F, 1.5F, -9F);
		...
		bodyModel[433].setRotationPoint(44.5F, -0.5F, -9F);
		...
		bodyModel[434].setRotationPoint(35F, -9F, -10F);
		...
		bodyModel[435].setRotationPoint(38F, 3F, -4F);
		...
		bodyModel[436].setRotationPoint(38F, 3F, 0F);
		...
		bodyModel[437].setRotationPoint(37F, -1.5F, 0F);
		...
		bodyModel[438].setRotationPoint(37F, -1.5F, -4F);
		...
		bodyModel[439].setRotationPoint(36.7F, -3.5F, -3F);
		...
		bodyModel[441].setRotationPoint(37.5F, 1F, 0.5F);
		...
		bodyModel[442].setRotationPoint(37.5F, 1F, -4.5F);
		...
		bodyModel[443].setRotationPoint(37.5F, 3.3F, -7.5F);
		...
		bodyModel[444].setRotationPoint(36.55F, -6.8F, -8.2F);
		...
		bodyModel[445].setRotationPoint(-33F, -8F, 8F);

		bodyModel[446].addBox(0F, 0F, 0F, 10, 2, 1, 0F); // Box 446
		bodyModel[446].setRotationPoint(-33F, -8F, 9F);
		...
		bodyModel[447].setRotationPoint(23F, -8F, 8F);

		bodyModel[448].addBox(0F, 0F, 0F, 10, 2, 1, 0F); // Box 448
		bodyModel[448].setRotationPoint(23F, -8F, 9F);
		...
		bodyModel[449].setRotationPoint(44F, -11F, 0.25F);
		...
		bodyModel[450].setRotationPoint(44F, -11F, 1.25F);
		...
		bodyModel[451].setRotationPoint(44F, -10F, 1.25F);
		...
		bodyModel[452].setRotationPoint(44F, -10F, 0.25F);
		...
		bodyModel[453].setRotationPoint(44F, -11F, -1.75F);
		...
		bodyModel[454].setRotationPoint(44F, -11F, -0.75F);
		...
		bodyModel[455].setRotationPoint(44F, -10F, -0.75F);
		...
		bodyModel[456].setRotationPoint(44F, -10F, -1.75F);
		this.flipAll();
	}
}