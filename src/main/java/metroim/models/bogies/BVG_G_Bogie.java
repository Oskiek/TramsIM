...
public class BVG_G_Bogie extends ModelBase //Same as Filename
{
    int textureX = 512;
    int textureY = 64;

    public BVG_G_Bogie() //Same as Filename
    {
    ...
    private void initbodyModel_1()
    {
        ...
        bodyModel[35] = new ModelRendererTurbo(this, 409, 1, textureX, textureY); // Box 42
        bodyModel[36] = new ModelRendererTurbo(this, 433, 1, textureX, textureY); // Box 43
        bodyModel[37] = new ModelRendererTurbo(this, 449, 1, textureX, textureY); // Box 44
        bodyModel[38] = new ModelRendererTurbo(this, 473, 1, textureX, textureY); // Box 45
        bodyModel[39] = new ModelRendererTurbo(this, 497, 1, textureX, textureY); // Box 46
        bodyModel[40] = new ModelRendererTurbo(this, 57, 9, textureX, textureY); // Box 47

        bodyModel[0].addBox(0F, 0F, 0F, 6, 3, 12, 0F); // Box 0
        bodyModel[0].setRotationPoint(-3.5F, 0F, -6.5F);

        bodyModel[1].addBox(0F, 0F, 0F, 1, 1, 10, 0F); // Box 1
        ...
        bodyModel[2].setRotationPoint(-8.5F, 0F, -6.5F);
        ...
        bodyModel[3].setRotationPoint(2.5F, 0F, -6.5F);
        ...
        bodyModel[4].setRotationPoint(2.5F, 0F, 3.5F);
        ...
        bodyModel[5].setRotationPoint(-8.5F, 0F, 3.5F);
        ...
        bodyModel[6].setRotationPoint(-4.5F, 2F, 4.5F);
        ...
        bodyModel[7].setRotationPoint(-8.5F, 5F, 4.5F);
        ...
        bodyModel[8].setRotationPoint(-7F, 3F, 4F);
        ...
        bodyModel[9].setRotationPoint(-8.5F, 2F, 4.5F);
        ...
        bodyModel[10].setRotationPoint(-4.5F, 3F, 4.5F);
        ...
        bodyModel[11].setRotationPoint(-8.5F, 3F, 4.5F);
        ...
        bodyModel[12].setRotationPoint(2.5F, 5F, 4.5F);
        ...
        bodyModel[13].setRotationPoint(2.5F, 2F, 4.5F);
        ...
        bodyModel[14].setRotationPoint(4F, 3F, 4F);
        ...
        bodyModel[15].setRotationPoint(6.5F, 3F, 4.5F);
        ...
        bodyModel[16].setRotationPoint(2.5F, 3F, 4.5F);
        ...
        bodyModel[17].setRotationPoint(6.5F, 2F, 4.5F);
        ...
        bodyModel[18].setRotationPoint(-8.5F, 2F, -6.5F);
        ...
        bodyModel[19].setRotationPoint(-4.5F, 2F, -6.5F);
        ...
        bodyModel[20].setRotationPoint(-7F, 3F, -7F);
        ...
        bodyModel[21].setRotationPoint(-8.5F, 5F, -6.5F);
        ...
        bodyModel[22].setRotationPoint(-8.5F, 3F, -6.5F);
        ...
        bodyModel[23].setRotationPoint(-4.5F, 3F, -6.5F);
        ...
        bodyModel[24].setRotationPoint(2.5F, 2F, -6.5F);
        ...
        bodyModel[25].setRotationPoint(6.5F, 2F, -6.5F);
        ...
        bodyModel[26].setRotationPoint(6.5F, 3F, -6.5F);
        ...
        bodyModel[27].setRotationPoint(2.5F, 3F, -6.5F);
        ...
        bodyModel[28].setRotationPoint(4F, 3F, -7F);
        ...
        bodyModel[29].setRotationPoint(2.5F, 5F, -6.5F);

        bodyModel[30].addBox(0F, 0F, 0F, 1, 1, 10, 0F); // Box 37
        bodyModel[30].setRotationPoint(4.5F, 3.5F, -5.5F);

        bodyModel[31].addBox(0F, 0F, 0F, 5, 5, 0, 0F); // Box 38
        bodyModel[31].setRotationPoint(-8.5F, 1.5F, -4.5F);

        bodyModel[32].addBox(0F, 0F, 0F, 5, 5, 0, 0F); // Box 39
        bodyModel[32].setRotationPoint(-8.5F, 1.5F, 3.5F);

        bodyModel[33].addBox(0F, 0F, 0F, 5, 5, 0, 0F); // Box 40
        bodyModel[33].setRotationPoint(2.5F, 1.5F, 3.5F);

        bodyModel[34].addBox(0F, 0F, 0F, 5, 5, 0, 0F); // Box 41
        bodyModel[34].setRotationPoint(2.5F, 1.5F, -4.5F);

        bodyModel[35].addShapeBox(0F, 0F, 0F, 9, 1, 2, 0F,0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F); // Box 42
        bodyModel[35].setRotationPoint(-13.5F, 1F, -1.5F);

        bodyModel[36].addBox(0F, 0F, 0F, 2, 3, 4, 0F); // Box 43
        bodyModel[36].setRotationPoint(-15.5F, 0F, -2.5F);

        bodyModel[37].addBox(0F, 0F, 0F, 6, 3, 3, 0F); // Box 44
        bodyModel[37].setRotationPoint(-2.5F, 2F, -0.5F);

        bodyModel[38].addBox(0F, 0F, 0F, 6, 3, 3, 0F); // Box 45
        bodyModel[38].setRotationPoint(-4.5F, 2F, -3.5F);

        bodyModel[39].addBox(0F, 0F, 0F, 3, 3, 1, 0F); // Box 46
        bodyModel[39].setRotationPoint(3.5F, 2.5F, 0.5F);

        bodyModel[40].addBox(0F, 0F, 0F, 3, 3, 1, 0F); // Box 47
        bodyModel[40].setRotationPoint(-7.5F, 2.5F, -2.5F);
    }
}