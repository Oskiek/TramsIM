...
import metroim.models.wagons.Tail3700_v2;
...
public class EntityFGV3700_Tail_v2 extends RollingstockBase {
    ...
    public static final Item thisItem = new ItemTransport(new EntityFGV3700_Tail_v2(null), MetroIM.MODID, MetroIM.metroimtabvehicle);

    public EntityFGV3700_Tail_v2(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityFGV3700_Tail_v2(World world){
        super(world);
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Tail3700_v2()};}
