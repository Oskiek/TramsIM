...
import metroim.models.wagons.Tail2000;
...
public class Entity2000_Tail extends RollingstockBase {
    private static final String[] itemDescription = new String[]{
            "\u00A77" + StatCollector.translateToLocal("menu.item.weight") +": 2 " + StatCollector.translateToLocal("menu.item.tons"),
            "\u00A77" + StatCollector.translateToLocal("menu.item.seats") +": 4 " + StatCollector.translateToLocal("menu.item.players")};
    public static final Item thisItem = new ItemTransport(new Entity2000_Tail(null), MetroIM.MODID, MetroIM.metroimtabvehicle);

    public Entity2000_Tail(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public Entity2000_Tail(World world){
        super(world);
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Tail2000()};}
