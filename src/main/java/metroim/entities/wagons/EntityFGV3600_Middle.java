...
public class EntityFGV3600_Middle extends RollingstockBase {
    ...
    public static final Item thisItem = new ItemTransport(new EntityFGV3600_Middle(null), MetroIM.MODID, MetroIM.metroimtabvehicle);

    public EntityFGV3600_Middle(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityFGV3600_Middle(World world){
        super(world);
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Middle3600()};}
