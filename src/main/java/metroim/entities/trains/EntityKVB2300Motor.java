...
public class EntityKVB2300Motor extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityKVB2300Motor(null), MetroIM.MODID,MetroIM.metroimtabvehicle);


    public EntityKVB2300Motor(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityKVB2300Motor(World world){
        super(world);
    }

    @Override
    public String transportName(){return "KVB_2300_Motor";}
    @Override
    public String transportcountry(){return "Germany";}
    @Override
    public String transportYear(){return "1989-1995";}
    @Override
    ...
    @Override
    public float[][] modelOffsets() { return new float[][]{{-0.125f,0.075f,0f}}; }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new KVB_2300()};}
