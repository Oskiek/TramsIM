...
import metroim.models.trains.Motor3900;
...
public class Entity3900motor extends TrainBase {



    public static final Item thisItem = new ItemTransport(new Entity3900motor(null), MetroIM.MODID, MetroIM.metroimtabvehicle);


    public Entity3900motor(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public Entity3900motor(World world){
        super(world);
    }

    @Override
    public String transportName(){return "FGV3900_Motor";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), MetroIM.MODID, "textures/trams/3900_end.png", "textures/trams/bogies/StandardBogie2.png",
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{1.1f,0.0f,0},{-1.195f,0.0f,0}};}
    @Override
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Motor3900()};}
