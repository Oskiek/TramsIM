...
import metroim.models.trains.Euskotren200;
...
public class EntityEuskotren200 extends TrainBase {
    ...
    public static final Item thisItem = new ItemTransport(new EntityEuskotren200(null), MetroIM.MODID,MetroIM.metroimtabvehicle);
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), MetroIM.MODID, "textures/trams/euskotren200_etfv.png", "textures/trams/bogies/fgv4300_bogie.png",
     ...
     */
    @Override
    public List<Double> getRenderBogieOffsets(){return  Arrays.asList(1.3125, -1.75);}
    /**
    ...
    public float[] getHitboxSize() {
        return new float[]{5.0625f,1.75f,1.5f};
    }
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{1.3125f,0f,0},{-1.75f,0f,0}};}
    @Override
    ...
    public float[] bogieLengthFromCenter() {
        return new float[]{1.3125f,-1.75f};
    }
