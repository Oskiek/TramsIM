...
import metroim.models.trains.Renfe440;
...
public class EntityRenfe440 extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityRenfe440(null), MetroIM.MODID,MetroIM.metroimtabvehicle);


    public EntityRenfe440(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRenfe440(World world){
        super(world);
    }

    @Override
    public String transportName(){return "Renfe440_motor";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), MetroIM.MODID, "textures/trams/440_cercanias.png", "textures/trams/bogies/fgv3700_bogie.png",
     ...
     */
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-1.8125f,1.1f, 0.34375f}};}

    @Override
    public float[] getHitboxSize() {
        return new float[]{5.3125f,1.75f,1.5f};
    }
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{1.5f,0.1f,0},{-2.25f,0.1f,0}};}
    @Override
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe440()};}
