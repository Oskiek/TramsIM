...
import metroim.models.trains.Motor3700_v2;
...
public class Entity3700Motor_v2 extends TrainBase {



    public static final Item thisItem = new ItemTransport(new Entity3700Motor_v2(null), MetroIM.MODID, MetroIM.metroimtabvehicle);


    public Entity3700Motor_v2(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public Entity3700Motor_v2(World world){
        super(world);
    }

    @Override
    public String transportName(){return "FGV3700_Motor_v2";}
    @Override
    public String transportcountry(){return "Spain";}
    @Override
    public String transportYear(){return "1990-2006";}
    @Override
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{0.925f,0.f,0},{-2.35f,0.0f,0}};}
    @Override
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Motor3700_v2()};}
