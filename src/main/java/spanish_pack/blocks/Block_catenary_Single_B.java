...
public class Block_catenary_Single_B extends BlockContainer {
	public Block_catenary_Single_B(){
		super(Material.iron);
		setBlockName("Catenary_single_B");
    ...
    {
        return new TileEntityCatenary_single_B();
    }
