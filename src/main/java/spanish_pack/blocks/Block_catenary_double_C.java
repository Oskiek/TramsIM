...
public class Block_catenary_double_C extends BlockContainer {
	public Block_catenary_double_C(){
		super(Material.iron);
		setBlockName("Catenary_double_C");
    ...
    {
        return new TileEntityCatenary_double_C();
    }
