...
import spanish_pack.models.wagons.Renfe440R_middle;
import spanish_pack.models.wagons.Renfe440R_tail;
...
public class EntityRenfe440Rmiddle extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityRenfe440Rmiddle(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public EntityRenfe440Rmiddle(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRenfe440Rmiddle(World world){
        super(world);
    }

    @Override
    public String transportName(){return "Renfe440R_middle";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/440R_cercanias_old.png", "textures/trams/bogies/446_bogie.png",
        "old cercanias livery", "Standard livery used in Spain.");
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/440R_cercanias_new.png", "textures/trams/bogies/446_bogie.png",
                "new cercanias livery", "Standard livery used in Spain.");
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/440R_Regional.png", "textures/trams/bogies/446_bogie.png",
                "Regional livery", "Standard livery used in Spain.");
    }
    ...
    @Override
    public float[][] modelOffsets() { return new float[][]{{0.0f,0.15f,0f}}; }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe440R_middle()};}
