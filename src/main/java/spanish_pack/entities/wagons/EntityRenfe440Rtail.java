...
public class EntityRenfe440Rtail extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityRenfe440Rtail(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public EntityRenfe440Rtail(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRenfe440Rtail(World world){
        super(world);
    }

    @Override
    public String transportName(){return "Renfe440R_tail";}
    @Override
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{1.8f,-0f,0f},{-2.0f,-0f,0f}};}
    @Override
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe440R_tail()};}
