...
public class EntityCivia_Middle extends RollingstockBase {
    private static final String[] itemDescription = new String[]{
            "\u00A77" + StatCollector.translateToLocal("menu.item.weight") +": 2 " + StatCollector.translateToLocal("menu.item.tons"),
            "\u00A77" + StatCollector.translateToLocal("menu.item.seats") +": 4 " + StatCollector.translateToLocal("menu.item.players")};
    public static final Item thisItem = new ItemTransport(new EntityCivia_Middle(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);

    public EntityCivia_Middle(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityCivia_Middle(World world){
        super(world);
    }
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{1.875f,0.05f,0}};}
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/civia_mt_middle.png", "textures/trams/bogies/446_bogie.png",
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe465_Middle()};}
