...
import spanish_pack.models.wagons.talgo_endcar_1axle;
...
public class Entitytalgoendcar1 extends TrainBase {



    public static final Item thisItem = new ItemTransport(new Entitytalgoendcar1(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public Entitytalgoendcar1(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public Entitytalgoendcar1(World world){
        super(world);
    }

    @Override
    public String transportName(){return "talgo IV Endcar 1";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/talgo_endcar_1axle.png", "textures/trams/bogies/446_bogie.png",
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new talgo_endcar_1axle()};}
