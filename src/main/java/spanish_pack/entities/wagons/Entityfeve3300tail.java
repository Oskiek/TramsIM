...
public class Entityfeve3300tail extends TrainBase {



    public static final Item thisItem = new ItemTransport(new Entityfeve3300tail(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public Entityfeve3300tail(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public Entityfeve3300tail(World world){
        super(world);
    }

    @Override
    public String transportName(){return "feve3300_tail";}
    @Override
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Feve3300_tail()};}
