...
public class EntityRenfe450tail extends RollingstockBase {
    private static final String[] itemDescription = new String[]{
            "\u00A77" + StatCollector.translateToLocal("menu.item.weight") +": 2 " + StatCollector.translateToLocal("menu.item.tons"),
            "\u00A77" + StatCollector.translateToLocal("menu.item.seats") +": 4 " + StatCollector.translateToLocal("menu.item.players")};
    public static final Item thisItem = new ItemTransport(new EntityRenfe450tail(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);

    public EntityRenfe450tail(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRenfe450tail(World world){
        super(world);
    }
    ...
    public void registerSkins(){
        ...
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/450_red_passenger.png", "textures/trams/bogies/446_bogie.png",
                "old", "Old livery used in the 90s.");
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe450tail()};}
