...
import spanish_pack.models.wagons.Euskotren200Middle;
...
public class EntityEuskotren200Middle extends RollingstockBase {
    ...
    public static final Item thisItem = new ItemTransport(new EntityEuskotren200Middle(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{1.3125f,0f,0},{-1.3125f,0f,0}};}
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/euskotren200_blue_middle.png", "textures/trams/bogies/StandardBogie2.png",
                "Euskotren old", "livery used by euskotren between 1995 and 2012.");
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/euskotren_etfv_middle.png", "textures/trams/bogies/StandardBogie2.png",
