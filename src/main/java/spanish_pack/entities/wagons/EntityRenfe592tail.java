...
public class EntityRenfe592tail extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityRenfe592tail(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public EntityRenfe592tail(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRenfe592tail(World world){
        super(world);
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe592tail()};}
