...
import spanish_pack.models.wagons.talgo_endcar_2axle;
...
public class Entitytalgoendcar2 extends TrainBase {



    public static final Item thisItem = new ItemTransport(new Entitytalgoendcar2(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public Entitytalgoendcar2(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public Entitytalgoendcar2(World world){
        super(world);
    }
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(), Spanish_pack.MODID, "textures/trams/talgo_endcar_2axle.png", "textures/trams/bogies/446_bogie.png",
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new talgo_endcar_2axle()};}
