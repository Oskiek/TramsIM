...
public class EntityEuskotren300 extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityEuskotren300(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public EntityEuskotren300(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityEuskotren300(World world){
        super(world);
    }

    @Override
    public String transportName(){return "Euskotren300";}
    @Override
    ...
    public void registerSkins(){
        ...
        "Topo", "Standard livery used in the Topo line during its first years in the 90s.");
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-1.98125f,1.1f, 0f}};}
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{1.5625f,0.0f,0},{-1.7625f,0f,0}};}
    @Override
    ...
    public float[] rotationPoints() {
        return new float[]{1.5125f,-1.5125f};
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Euskotren300()};}
