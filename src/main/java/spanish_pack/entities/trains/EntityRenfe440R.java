...
import spanish_pack.models.trains.Renfe440R;
...
public class EntityRenfe440R extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityRenfe440R(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public EntityRenfe440R(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRenfe440R(World world){
        super(world);
    }

    @Override
    public String transportName(){return "Renfe440R_motor";}
    @Override
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe440R()};}
