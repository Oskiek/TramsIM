...
import spanish_pack.models.trains.Renfe465_w_panto;
...
public class EntityRenfeCivia_w_Panto extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityRenfeCivia_w_Panto(null), Spanish_pack.MODID, Spanish_pack.spanish_pack);


    public EntityRenfeCivia_w_Panto(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRenfeCivia_w_Panto(World world){
        super(world);
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Renfe465_w_panto()};}
