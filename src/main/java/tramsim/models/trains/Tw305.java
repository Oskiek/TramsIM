...
public class Tw305 extends ModelBase //Same as Filename
{
	int textureX = 512;
	int textureY = 128;

	public Tw305() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[109] = new ModelRendererTurbo(this, 497, 1, textureX, textureY); // Box 154
		bodyModel[110] = new ModelRendererTurbo(this, 249, 9, textureX, textureY); // Box 152
		bodyModel[111] = new ModelRendererTurbo(this, 377, 9, textureX, textureY); // Box 151
		bodyModel[112] = new ModelRendererTurbo(this, 289, 17, textureX, textureY); // Box 153
		...
		bodyModel[137] = new ModelRendererTurbo(this, 65, 49, textureX, textureY); // Box 221
		bodyModel[138] = new ModelRendererTurbo(this, 81, 49, textureX, textureY); // Box 222
		bodyModel[139] = new ModelRendererTurbo(this, 201, 49, textureX, textureY); // Box 223
		bodyModel[140] = new ModelRendererTurbo(this, 217, 49, textureX, textureY); // Box 224
		...
		bodyModel[170] = new ModelRendererTurbo(this, 1, 96, textureX, textureY); // Box 170
		bodyModel[171] = new ModelRendererTurbo(this, 1, 96, textureX, textureY); // Box 171
		bodyModel[172] = new ModelRendererTurbo(this, 1, 106, textureX, textureY); // Box 172
		...
		bodyModel[185] = new ModelRendererTurbo(this, 245, 85, textureX, textureY); // Box 294
		bodyModel[186] = new ModelRendererTurbo(this, 245, 85, textureX, textureY); // Box 187
		...
		bodyModel[149].setRotationPoint(-27.5F, 4.5F, -6F);
		...
		bodyModel[168].setRotationPoint(27.5F, 4.5F, -6F);
