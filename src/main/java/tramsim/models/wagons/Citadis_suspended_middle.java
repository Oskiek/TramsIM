...
public class Citadis_suspended_middle extends ModelBase //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public Citadis_suspended_middle() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[33].setRotationPoint(-13F, -22F, -6F);

		bodyModel[34].addBox(0F, 0F, 0F, 12, 6, 14, 0F); // Box 59
		bodyModel[34].setRotationPoint(-4F, -23F, -7F);
