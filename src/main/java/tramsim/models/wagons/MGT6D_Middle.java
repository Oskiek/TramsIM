...
public class MGT6D_Middle extends ModelBase //Same as Filename
{
    ...
    private void initbodyModel_1()
    {
        ...
        bodyModel[46] = new ModelRendererTurbo(this, 113, 1, textureX, textureY); // Box 146
        ...
        bodyModel[1].setRotationPoint(-25F, -17F, -10F);
        ...
        bodyModel[2].setRotationPoint(-25F, -17F, 7F);

        bodyModel[3].addBox(0F, 0F, 0F, 20, 8, 1, 0F); // Box 43
        bodyModel[3].setRotationPoint(-25F, -1F, 7F);
        ...
        bodyModel[4].setRotationPoint(-5F, 5F, -10F);
        ...
        bodyModel[5].setRotationPoint(-25F, -17F, -10F);
        ...
        bodyModel[7].setRotationPoint(-5F, 6F, -10F);
        ...
        bodyModel[8].setRotationPoint(-25F, -17F, 6F);
        ...
        bodyModel[9].setRotationPoint(-6F, -5F, 3F);
        ...
        bodyModel[10].setRotationPoint(-6F, -5F, -9F);
        ...
        bodyModel[11].setRotationPoint(5F, -3F, -9F);
        ...
        bodyModel[12].setRotationPoint(5F, -3F, 3F);

        bodyModel[13].addBox(0F, 0F, 0F, 6, 3, 6, 0F); // Box 64
        bodyModel[13].setRotationPoint(-13.5F, 2F, 1F);
        ...
        bodyModel[14].setRotationPoint(-11F, -2F, -9F);

        bodyModel[15].addBox(0F, 0F, 0F, 6, 3, 6, 0F); // Box 66
        bodyModel[15].setRotationPoint(-13.5F, 2F, -9F);
        ...
        bodyModel[16].setRotationPoint(-11F, -2F, 1F);

        bodyModel[17].addBox(0F, 0F, 0F, 6, 3, 6, 0F); // Box 69
        bodyModel[17].setRotationPoint(-22.5F, 2F, -9F);
        ...
        bodyModel[18].setRotationPoint(-20F, -2F, -9F);

        bodyModel[19].addBox(0F, 0F, 0F, 6, 3, 6, 0F); // Box 71
        bodyModel[19].setRotationPoint(-22.5F, 2F, 1F);
        ...
        bodyModel[20].setRotationPoint(-20F, -2F, 1F);

        bodyModel[21].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 73
        bodyModel[21].setRotationPoint(-19.5F, -4F, -5F);

        bodyModel[22].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 74
        bodyModel[22].setRotationPoint(-19.5F, -4F, 1F);

        bodyModel[23].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 75
        bodyModel[23].setRotationPoint(-10.5F, -4F, 1F);

        bodyModel[24].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 76
        bodyModel[24].setRotationPoint(-10.5F, -4F, -5F);

        bodyModel[25].addBox(0F, 0F, 0F, 10, 3, 14, 0F); // Box 97
        bodyModel[25].setRotationPoint(-24F, -20F, -8F);
        ...
        bodyModel[26].setRotationPoint(-25F, -19F, -12.3F);
        ...
        bodyModel[27].setRotationPoint(-25F, -19F, 4.8F);

        bodyModel[28].addBox(0F, 0F, 0F, 10, 3, 12, 0F); // Box 102
        bodyModel[28].setRotationPoint(7F, -20F, -7F);

        bodyModel[29].addBox(0F, 0F, 0F, 8, 3, 12, 0F); // Box 103
        bodyModel[29].setRotationPoint(17F, -20F, -7F);
        ...
        bodyModel[30].setRotationPoint(0F, -13F, -10F);
        ...
        bodyModel[31].setRotationPoint(0F, -13F, 7F);
        ...
        bodyModel[32].setRotationPoint(-5F, -13F, 7F);

        bodyModel[33].addBox(0F, 0F, 0F, 5, 7, 1, 0F); // Box 110
        bodyModel[33].setRotationPoint(-5F, -1F, 7F);

        bodyModel[34].addBox(0F, 0F, 0F, 4, 8, 0, 0F); // Box 112
        bodyModel[34].setRotationPoint(25F, -1F, -10F);
        ...
        bodyModel[35].setRotationPoint(25F, -19F, -10F);
        ...
        bodyModel[38].setRotationPoint(24F, -1F, 3F);
        ...
        bodyModel[39].setRotationPoint(24F, -1F, -8F);

        bodyModel[40].addBox(0F, 0F, 0F, 1, 19, 1, 0F); // Box 100
        bodyModel[40].setRotationPoint(24F, -14F, 6F);

        bodyModel[41].addBox(0F, 0F, 0F, 1, 19, 1, 0F); // Box 101
        bodyModel[41].setRotationPoint(24F, -14F, -9F);
        ...
        bodyModel[42].setRotationPoint(25F, -17F, -9F);
        ...
        bodyModel[43].setRotationPoint(25F, -17F, 7F);
        ...
        bodyModel[44].setRotationPoint(25F, -1F, -9F);
        ...
        bodyModel[45].setRotationPoint(25F, -1F, 4F);
        ...
        bodyModel[46].setRotationPoint(4F, -14F, -4F);
        ...
        bodyModel[47].setRotationPoint(7F, -14F, -4F);
        ...
        bodyModel[48].setRotationPoint(16F, -14F, -4F);
        ...
        bodyModel[49].setRotationPoint(-6.5F, -8F, -5F);
        ...
        bodyModel[50].setRotationPoint(-6.5F, -8F, 1.5F);
        ...
        bodyModel[51].setRotationPoint(4.5F, -8F, 1.5F);
        ...
        bodyModel[52].setRotationPoint(4.5F, -8F, -5F);

        bodyModel[53].addBox(0F, 0F, 0F, 5, 7, 1, 0F); // Box 115
        bodyModel[53].setRotationPoint(0F, -1F, 7F);

        bodyModel[54].addBox(0F, 0F, 0F, 5, 7, 1, 0F); // Box 116
        bodyModel[54].setRotationPoint(-5F, -1F, -10F);

        bodyModel[55].addBox(0F, 0F, 0F, 5, 7, 1, 0F); // Box 117
        bodyModel[55].setRotationPoint(0F, -1F, -10F);
        ...
        bodyModel[56].setRotationPoint(-5F, -13F, -10F);
        ...
        bodyModel[57].setRotationPoint(-20F, 5F, -9F);

        bodyModel[58].addBox(0F, 0F, 0F, 20, 8, 1, 0F); // Box 109
        bodyModel[58].setRotationPoint(5F, -1F, -10F);
        ...
        bodyModel[59].setRotationPoint(5F, -17F, -10F);
        ...
        bodyModel[61].addBox(0F, 0F, 0F, 20, 8, 1, 0F); // Box 112
        bodyModel[61].setRotationPoint(5F, -1F, 7F);
        ...
        bodyModel[62].setRotationPoint(5F, -17F, 7F);

        bodyModel[63].addBox(0F, 0F, 0F, 6, 3, 6, 0F); // Box 79
        bodyModel[63].setRotationPoint(7.5F, 2F, -9F);

        bodyModel[64].addBox(0F, 0F, 0F, 6, 3, 6, 0F); // Box 80
        bodyModel[64].setRotationPoint(16.5F, 2F, -9F);
        ...
        bodyModel[65].setRotationPoint(10F, -2F, -9F);
        ...
        bodyModel[66].setRotationPoint(19F, -2F, -9F);

        bodyModel[67].addBox(0F, 0F, 0F, 6, 3, 6, 0F); // Box 83
        bodyModel[67].setRotationPoint(7.5F, 2F, 1F);
        ...
        bodyModel[68].setRotationPoint(10F, -2F, 1F);
        ...
        bodyModel[70].setRotationPoint(19F, -2F, 1F);

        bodyModel[71].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 87
        bodyModel[71].setRotationPoint(10.5F, -4F, -5F);

        bodyModel[72].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 88
        bodyModel[72].setRotationPoint(19.5F, -4F, -5F);

        bodyModel[73].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 89
        bodyModel[73].setRotationPoint(19.5F, -4F, 1F);

        bodyModel[74].addBox(0F, 0F, 0F, 0, 2, 2, 0F); // Box 90
        bodyModel[74].setRotationPoint(10.5F, -4F, 1F);
        ...
        bodyModel[75].setRotationPoint(-25F, -1F, 3F);

        bodyModel[76].addBox(0F, 0F, 0F, 1, 19, 1, 0F); // Box 92
        bodyModel[76].setRotationPoint(-25F, -14F, 6F);
        ...
        bodyModel[77].setRotationPoint(-25F, -1F, -8F);

        bodyModel[78].addBox(0F, 0F, 0F, 1, 19, 1, 0F); // Box 94
        bodyModel[78].setRotationPoint(-25F, -14F, -9F);
        ...
        bodyModel[79].setRotationPoint(-28F, -1F, 4F);
        ...
        bodyModel[80].setRotationPoint(-28F, -1F, -9F);
        ...
        bodyModel[81].setRotationPoint(-28F, -17F, -9F);
        ...
        bodyModel[85].setRotationPoint(-28F, -17F, 7F);
        ...
        bodyModel[86].setRotationPoint(-31F, -19F, 6.9F);
        ...
        bodyModel[87].setRotationPoint(14F, -13F, 7F);
        ...
        bodyModel[88].setRotationPoint(24F, -13F, 7F);
        ...
        bodyModel[89].setRotationPoint(5F, -13F, 7F);
        ...
        bodyModel[90].setRotationPoint(-6F, -13F, 7F);
        ...
        bodyModel[91].setRotationPoint(-16F, -13F, 7F);
        ...
        bodyModel[92].setRotationPoint(-25F, -13F, 7F);
        ...
        bodyModel[93].setRotationPoint(14.5F, -13F, -10F);
        ...
        bodyModel[94].setRotationPoint(24F, -13F, -10F);
        ...
        bodyModel[95].setRotationPoint(5F, -13F, -10F);
        ...
        bodyModel[96].setRotationPoint(-6F, -13F, -10F);
        ...
        bodyModel[97].setRotationPoint(-15.5F, -13F, -10F);
        ...
        bodyModel[98].setRotationPoint(-25F, -13F, -10F);
        ...
        bodyModel[99].setRotationPoint(25F, -17F, -7.5F);
        ...
        bodyModel[100].setRotationPoint(-28F, -17F, -7.5F);
        ...
        bodyModel[102].setRotationPoint(-5F, -16F, -9F);
        ...
        bodyModel[103].setRotationPoint(-5F, -16F, 3F);

        bodyModel[104].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 119
        bodyModel[104].setRotationPoint(0F, -18F, 2F);

        bodyModel[105].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 120
        bodyModel[105].setRotationPoint(4F, -18F, 2F);

        bodyModel[106].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 117
        bodyModel[106].setRotationPoint(4F, -18F, -5F);

        bodyModel[107].addBox(0F, 0F, 0F, 5, 1, 1, 0F); // Box 124
        bodyModel[107].setRotationPoint(0F, -19F, 2F);

        bodyModel[108].addBox(0F, 0F, 0F, 5, 1, 1, 0F); // Box 109
        bodyModel[108].setRotationPoint(0F, -19F, -5F);

        bodyModel[109].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Box 122
        bodyModel[109].setRotationPoint(2F, -19F, -5F);
        ...
        bodyModel[110].setRotationPoint(-6F, -24F, -2F);

        bodyModel[111].addBox(0F, 0F, 0F, 1, 1, 4, 0F); // Box 125
        bodyModel[111].setRotationPoint(-7F, -24F, -3F);
        ...
        bodyModel[112].setRotationPoint(-6F, -29F, -5F);
        ...
        bodyModel[113].setRotationPoint(-6F, -29F, 2F);

        bodyModel[114].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 131
        bodyModel[114].setRotationPoint(2F, -29F, 2F);

        bodyModel[115].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 116
        bodyModel[115].setRotationPoint(2F, -29F, -5F);

        bodyModel[116].addBox(0F, 0F, 0F, 1, 1, 14, 0F); // Box 130
        bodyModel[116].setRotationPoint(2F, -30F, -8F);

        bodyModel[117].addBox(0F, 0F, 0F, 1, 1, 14, 0F); // Box 118
        bodyModel[117].setRotationPoint(4F, -30F, -8F);

        bodyModel[118].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 119
        bodyModel[118].setRotationPoint(0F, -18F, -5F);
        ...
        bodyModel[119].setRotationPoint(-18F, 4F, -9F);
        ...
        bodyModel[120].setRotationPoint(12F, 4F, -9F);
        this.flipAll();
    }
}