...
public class PT8_Bogie extends ModelBase //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[3] = new ModelRendererTurbo(this, 233, 1, textureX, textureY); // Box 21
		bodyModel[4] = new ModelRendererTurbo(this, 249, 1, textureX, textureY); // Box 22
		bodyModel[5] = new ModelRendererTurbo(this, 265, 1, textureX, textureY); // Box 23
		bodyModel[6] = new ModelRendererTurbo(this, 281, 1, textureX, textureY); // Box 24
		bodyModel[7] = new ModelRendererTurbo(this, 297, 1, textureX, textureY); // Box 25
		bodyModel[8] = new ModelRendererTurbo(this, 233, 1, textureX, textureY); // Box 26
		bodyModel[9] = new ModelRendererTurbo(this, 265, 1, textureX, textureY); // Box 27
		bodyModel[10] = new ModelRendererTurbo(this, 313, 1, textureX, textureY); // Box 28
		bodyModel[11] = new ModelRendererTurbo(this, 353, 1, textureX, textureY); // Box 29
		bodyModel[12] = new ModelRendererTurbo(this, 313, 1, textureX, textureY); // Box 29
		bodyModel[13] = new ModelRendererTurbo(this, 313, 1, textureX, textureY); // Box 30
		bodyModel[14] = new ModelRendererTurbo(this, 313, 1, textureX, textureY); // Box 31
		...
		bodyModel[2].setRotationPoint(-2F, 4F, -4F);

		bodyModel[3].addBox(0F, 0F, 0F, 5, 5, 0, 0F); // Box 21
		bodyModel[3].setRotationPoint(-8F, 3F, -4F);

		bodyModel[4].addBox(0F, 0F, 0F, 6, 3, 1, 0F); // Box 22
		bodyModel[4].setRotationPoint(-2F, 4F, 3F);

		bodyModel[5].addBox(0F, 0F, 0F, 5, 5, 0, 0F); // Box 23
		bodyModel[5].setRotationPoint(-8F, 3F, 4F);
		...
		bodyModel[7].setRotationPoint(5F, 3F, -4F);
		...
		bodyModel[9].setRotationPoint(-6F, 5F, -6F);

		bodyModel[10].addBox(0F, 0F, 0F, 18, 1, 1, 0F); // Box 28
		bodyModel[10].setRotationPoint(-8F, 6F, 5F);

		bodyModel[11].addBox(0F, 0F, 0F, 18, 1, 1, 0F); // Box 29
		bodyModel[11].setRotationPoint(-8F, 6F, -6F);

		bodyModel[12].addBox(0F, 0F, 0F, 14, 2, 2, 0F); // Box 29
		bodyModel[12].setRotationPoint(-6F, 5F, -1F);

		bodyModel[13].addBox(0F, 0F, 0F, 6, 3, 4, 0F); // Box 30
		bodyModel[13].setRotationPoint(-7F, 4F, -1F);
