...
public class PT8_Gelenk extends ModelBase //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[20] = new ModelRendererTurbo(this, 249, 1, textureX, textureY); // Box 22
		bodyModel[21] = new ModelRendererTurbo(this, 233, 1, textureX, textureY); // Box 26
		bodyModel[22] = new ModelRendererTurbo(this, 265, 1, textureX, textureY); // Box 27
		bodyModel[23] = new ModelRendererTurbo(this, 313, 1, textureX, textureY); // Box 28
		bodyModel[24] = new ModelRendererTurbo(this, 353, 1, textureX, textureY); // Box 29
		bodyModel[25] = new ModelRendererTurbo(this, 313, 1, textureX, textureY); // Box 29
		bodyModel[26] = new ModelRendererTurbo(this, 265, 1, textureX, textureY, " wheel "); // Box 23
		bodyModel[27] = new ModelRendererTurbo(this, 265, 1, textureX, textureY, " wheel "); // Box 15
		bodyModel[28] = new ModelRendererTurbo(this, 265, 1, textureX, textureY, " wheel "); // Box 23
		bodyModel[29] = new ModelRendererTurbo(this, 265, 1, textureX, textureY, " wheel "); // Box 15

		bodyModel[0].addBox(0F, 0F, 0F, 4, 20, 1, 0F); // Box 0
		bodyModel[0].setRotationPoint(-2F, -15F, 7F);

		bodyModel[1].addBox(0F, 0F, 0F, 6, 1, 10, 0F); // Box 1
		bodyModel[1].setRotationPoint(-3F, 2F, -5F);

		bodyModel[2].addBox(0F, 0F, 0F, 4, 20, 1, 0F); // Box 3
		bodyModel[2].setRotationPoint(-2F, -15F, -8F);

		bodyModel[3].addShapeBox(0F, 0F, 0F, 4, 1, 14, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F); // Box 4
		bodyModel[3].setRotationPoint(-2F, -16F, -7F);

		bodyModel[4].addBox(0F, 0F, 0F, 4, 15, 1, 0F); // Box 5
		bodyModel[4].setRotationPoint(-2F, -13F, -6F);

		bodyModel[5].addBox(0F, 0F, 0F, 4, 15, 1, 0F); // Box 6
		bodyModel[5].setRotationPoint(-2F, -13F, 5F);

		bodyModel[6].addBox(0F, 0F, 0F, 6, 1, 10, 0F); // Box 7
		bodyModel[6].setRotationPoint(-3F, -14F, -5F);

		bodyModel[7].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 8
		bodyModel[7].setRotationPoint(0F, 0F, 6F);

		bodyModel[8].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 9
		bodyModel[8].setRotationPoint(0F, -6F, 6F);

		bodyModel[9].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 10
		bodyModel[9].setRotationPoint(0F, -12F, 6F);

		bodyModel[10].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 11
		bodyModel[10].setRotationPoint(0F, -12F, -7F);

		bodyModel[11].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 12
		bodyModel[11].setRotationPoint(0F, -6F, -7F);

		bodyModel[12].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 13
		bodyModel[12].setRotationPoint(0F, 0F, -7F);
		...
		bodyModel[13].setRotationPoint(2F, -13F, -6F);
		...
		bodyModel[14].setRotationPoint(2F, -13F, 5F);
		...
		bodyModel[15].setRotationPoint(-3F, -13F, 5F);
		...
		bodyModel[16].setRotationPoint(-3F, -13F, -6F);
		...
		bodyModel[20].addBox(0F, 0F, 0F, 6, 3, 1, 0F); // Box 22
		bodyModel[20].setRotationPoint(-3F, 4F, 3F);

		bodyModel[21].addBox(0F, 0F, 0F, 1, 1, 12, 0F); // Box 26
		bodyModel[21].setRotationPoint(6F, 5F, -6F);

		bodyModel[22].addBox(0F, 0F, 0F, 1, 1, 12, 0F); // Box 27
		bodyModel[22].setRotationPoint(-7F, 5F, -6F);

		bodyModel[23].addBox(0F, 0F, 0F, 18, 1, 1, 0F); // Box 28
		bodyModel[23].setRotationPoint(-9F, 6F, 5F);

		bodyModel[24].addBox(0F, 0F, 0F, 18, 1, 1, 0F); // Box 29
		bodyModel[24].setRotationPoint(-9F, 6F, -6F);

		bodyModel[25].addBox(0F, 0F, 0F, 14, 2, 2, 0F); // Box 29
		bodyModel[25].setRotationPoint(-7F, 5F, -1F);

		bodyModel[26].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // Box 23
		bodyModel[26].setRotationPoint(-6.5F, 5.5F, 4F).rotateAngleY = -3.14159265F;

		bodyModel[27].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // Box 15
		bodyModel[27].setRotationPoint(-6.5F, 5.5F, -4F).rotateAngleY = -3.14159265F;

		bodyModel[28].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // Box 23
		bodyModel[28].setRotationPoint(6.5F, 5.5F, 4F).rotateAngleY = -3.14159265F;

		bodyModel[29].addBox(-2.5F, -2.5F, 0F, 5, 5, 0, 0F); // Box 15
		bodyModel[29].setRotationPoint(6.5F, 5.5F, -4F).rotateAngleY = -3.14159265F;
	}
}