...
public class ModelBusStop_3_Left_1 extends ModelBase //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public ModelBusStop_3_Left_1() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(0F, -29F, 15F);

		bodyModel[1].addBox(0F, 0F, 0F, 12, 23, 0, 0F); // Box 8
		bodyModel[1].setRotationPoint(1F, -28F, 15.5F);
		...
		bodyModel[3].setRotationPoint(1F, -29F, 15F);
		...
		bodyModel[5].setRotationPoint(1F, -5F, 15F);
		...
		bodyModel[9].setRotationPoint(0F, -31F, 15F);
		...
		bodyModel[10].setRotationPoint(1F, -33F, 15F);
		...
		bodyModel[11].setRotationPoint(0F, -31F, 0F);
		...
		bodyModel[12].setRotationPoint(13F, -31F, 0F);
		...
		bodyModel[14].setRotationPoint(1F, -33F, 0F);
		...
		bodyModel[15].setRotationPoint(12F, -33F, 0F);

		bodyModel[16].addBox(0F, 0F, 0F, 1, 1, 10, 0F); // Box 17
		bodyModel[16].setRotationPoint(9F, -7F, 1F);

		bodyModel[17].addShapeBox(0F, 0F, 0F, 4, 1, 12, 0F,-0.25F, -0.5F, 0F, -0.25F, -0.5F, 0F, -0.25F, -0.5F, -0.25F, -0.25F, -0.5F, -0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 18
		bodyModel[17].setRotationPoint(8.5F, -8F, 0F);

		bodyModel[18].addBox(0F, 0F, 0F, 3, 1, 1, 0F); // Box 19
		bodyModel[18].setRotationPoint(9F, -7F, 0F);
