...
public class ModelBusStop_2_Middle_3 extends ModelBase //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public ModelBusStop_2_Middle_3() //Same as Filename
	{
		...
		bodyModel[4] = new ModelRendererTurbo(this, 20, 60, textureX, textureY); // Box 6
		...
		bodyModel[4].addBox(0F, 0F, 0F, 1, 16, 14, 0F); // Box 6
