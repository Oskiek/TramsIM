...
public class ModelEdgeLeftCorner extends ModelBase {
    int textureX = 64;
    int textureY = 64;

    public ModelEdgeLeftCorner() //Same as Filename
    {
    ...
    private void initbodyModel_1()
    {
        ...
        bodyModel[1].setRotationPoint(-6F, 16F, -8F);

        bodyModel[2].addBox(0F, 0F, 0F, 2, 4, 6, 0F); // Box 3
        bodyModel[2].setRotationPoint(-4F, 16F, -8F);

        bodyModel[3].addBox(0F, 0F, 0F, 2, 4, 5, 0F); // Box 4
        bodyModel[3].setRotationPoint(-2F, 16F, -8F);

        bodyModel[4].addBox(0F, 0F, 0F, 2, 4, 4, 0F); // Box 5
        bodyModel[4].setRotationPoint(0F, 16F, -8F);

        bodyModel[5].addBox(0F, 0F, 0F, 2, 4, 3, 0F); // Box 6
        bodyModel[5].setRotationPoint(2F, 16F, -8F);

        bodyModel[6].addBox(0F, 0F, 0F, 2, 4, 2, 0F); // Box 7
        bodyModel[6].setRotationPoint(4F, 16F, -8F);

        bodyModel[7].addBox(0F, 0F, 0F, 2, 4, 1, 0F); // Box 8
        bodyModel[7].setRotationPoint(6F, 16F, -8F);
    }
}