...
public class ModelBusStop_2_Right_1 extends ModelBase //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public ModelBusStop_2_Right_1() //Same as Filename
	{
		...
		bodyModel[8] = new ModelRendererTurbo(this, 57, 62, textureX, textureY); // Box 9
		...
		bodyModel[0].setRotationPoint(0F, -31F, 0F);
		...
		bodyModel[7].setRotationPoint(1F, -31F, 0.5F);
		...
		bodyModel[9].setRotationPoint(0F, -29F, 1F);
