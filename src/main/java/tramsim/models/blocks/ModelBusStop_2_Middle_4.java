...
public class ModelBusStop_2_Middle_4 extends ModelBase //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public ModelBusStop_2_Middle_4() //Same as Filename
	{
		...
		bodyModel[6] = new ModelRendererTurbo(this, 57, 61, textureX, textureY); // Box 9
