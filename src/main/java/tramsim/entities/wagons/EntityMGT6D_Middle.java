...
public class EntityMGT6D_Middle extends RollingstockBase {
    ...
    public static final Item thisItem = new ItemTransport(new EntityMGT6D_Middle(null), TramsIM.MODID, TramsIM.tramsimtabvehicle);

    public EntityMGT6D_Middle(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityMGT6D_Middle(World world){
        super(world);
    }
    ...
    public float[] getHitboxSize() {
        return new float[]{3.375f,1.75f,1.5f};
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new MGT6D_Middle()};}
