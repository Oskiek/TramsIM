...
import tramsim.models.wagons.M8S_Middle;

import java.util.List;
import java.util.UUID;

public class EntityM8S_Middle extends RollingstockBase {
    private static final String[] itemDescription = new String[]{
            "\u00A77" + StatCollector.translateToLocal("menu.item.weight") +": 2 " + StatCollector.translateToLocal("menu.item.tons"),
            "\u00A77" + StatCollector.translateToLocal("menu.item.seats") +": 4 " + StatCollector.translateToLocal("menu.item.players")};
    public static final Item thisItem = new ItemTransport(new EntityM8S_Middle(null), TramsIM.MODID, TramsIM.tramsimtabvehicle);

    public EntityM8S_Middle(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityM8S_Middle(World world){
        super(world);
    }
    ...
    @Override
    public ModelBase[] bogieModels(){  return new ModelBase[]{new NullBogiePlaceHolder(), new M8S_Gelenk()};}
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new M8S_Middle()};}
