...
import tramsim.models.wagons.Citadis_suspended_middle_panto;
...
public class EntityCitadis_suspended_middle_panto extends RollingstockBase {
    private static final String[] itemDescription = new String[]{
            "\u00A77" + StatCollector.translateToLocal("menu.item.weight") +": 2 " + StatCollector.translateToLocal("menu.item.tons"),
            "\u00A77" + StatCollector.translateToLocal("menu.item.seats") +": 4 " + StatCollector.translateToLocal("menu.item.players")};
    public static final Item thisItem = new ItemTransport(new EntityCitadis_suspended_middle_panto(null), TramsIM.MODID, TramsIM.tramsimtabvehicle);

    public EntityCitadis_suspended_middle_panto(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityCitadis_suspended_middle_panto(World world){
        super(world);
    }
    ...
    public String transportName() {
        return "Citadis suspended middle panto";
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Citadis_suspended_middle_panto()};}
