...
import tramsim.models.trains.TatraT3Short;
...
public class EntityTatraT3Short extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityTatraT3Short(null), TramsIM.MODID,null);


    public EntityTatraT3Short(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityTatraT3Short(World world){
        super(world);
    }

    @Override
    public String transportName(){return "TatraT3Short";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),TramsIM.MODID, "textures/trams/tatrat3_short.png", "textures/trams/bogies/kt4_bogie.png",
        "shorttram", RailUtility.translate("shorttram.description"));
    }
     ...
     */
    @Override
    public List<Double> getRenderBogieOffsets(){return  Arrays.asList(0.0);}
    /**
     ...
     */
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-0.625f,1f, 0.1875f}};}

    @Override
    public float[] getHitboxSize() {
        return new float[]{2.5f,2f,1.5f};
    }
     ...
     */
    @Override
    public double[][] getHitboxPositions(){return new double[][]{{-4.25d,0.25d,0d},{-4d,0.25d,0d},{0d,0.25d,0d},{4d, 0.25d,0d},{4.25d,0.25d,0d}};}
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new TatraT3Short()};}
