...
import tramsim.models.trains.KonstalN;
...
public class EntityKonstalN extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityKonstalN(null), TramsIM.MODID,TramsIM.tramsimtabvehicle);


    public EntityKonstalN(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityKonstalN(World world){
        super(world);
    }

    @Override
    public String transportName(){return "KonstalN";}
    @Override
    public String transportcountry(){return "Poland";}
    @Override
    public String transportYear(){return "1948+";}
    @Override
     ...
     */
    @Override
    public List<Double> getRenderBogieOffsets(){return  Arrays.asList(0.1, -0.1);}
    /**
    ...
    public float[] getHitboxSize() {
        return new float[]{6.5f,2.25f,1.5f};
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new KonstalN()};}
