...
import tramsim.models.trains.PCC;
...
public class EntityPCC extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityPCC(null), TramsIM.MODID, TramsIM.tramsimtabvehicle);


    public EntityPCC(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityPCC(World world){
        super(world);
    }

    @Override
    public String transportName(){return "PCC";}
    @Override
    ...
    public void registerSkins(){
        ...
        "company.chicago", CommonUtil.translate("standardlivery") + " " + CommonUtil.translate("in.chicago") + ".");
    }

    public String getDefaultSkin(){
        return "tramsim:company.chicago";
    }
     ...
     */
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-3.75f,1.0f, 0.25f}};}
    ...
    @Override
    public float weightKg(){return 11350f;}
...
//
    ...
    @Override
    public float[][] modelOffsets() { return new float[][]{{0,-0.5f,0}}; }
