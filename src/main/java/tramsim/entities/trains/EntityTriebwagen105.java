...
public class EntityTriebwagen105 extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityTriebwagen105(null), TramsIM.MODID,TramsIM.tramsimtabvehicle);


    public EntityTriebwagen105(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityTriebwagen105(World world){
        super(world);
    }

    @Override
    public String transportName(){return "Triebwagen105";}
    @Override
    public String transportcountry(){return "Germany";}
    @Override
    public String transportYear(){return "1927+";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),TramsIM.MODID, "textures/trams/triebwagen105.png",
        "company.elberfeld", CommonUtil.translate("standardlivery") + " " + CommonUtil.translate("in.wuppertal") + ".");
    }

    public String getDefaultSkin(){
        return "tramsim:company.elberfeld";
    }
    ...
    public float[] getHitboxSize() {
        return new float[]{4.75f,2.25f,1.5f};
    }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Triebwagen105()};}
