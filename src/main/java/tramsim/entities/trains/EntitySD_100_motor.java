...
public class EntitySD_100_motor extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntitySD_100_motor(null), TramsIM.MODID,TramsIM.tramsimtabvehicle);


    public EntitySD_100_motor(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntitySD_100_motor(World world){
        super(world);
    }

    @Override
    public String transportName(){return "SD_100";}
    @Override
    ...
    @Override
    public float[][] getRiderOffsets(){return new float[][]{{-1.825f,0.9f, 0f}};}
    ...
    public float[][] bogieModelOffsets() {
        return new float[][]{{0.175f,-0.06f,0},{-2.325f,-0.06f,0}};}
    @Override
    public ModelBase[] bogieModels(){  return new ModelBase[]{new SD_100_Bogie(), new SD_100_articulation()};}
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new SD_100_front()};}
