...
import tramsim.models.trains.RussiaOne;
...
public class EntityRussiaOne extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityRussiaOne(null), TramsIM.MODID,TramsIM.tramsimtabvehicle);


    public EntityRussiaOne(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityRussiaOne(World world){
        super(world);
    }

    @Override
    public String transportName(){return "RussiaOne_end";}
    @Override
    public String transportcountry(){return "Russia";}
    @Override
    public String transportYear(){return "2018+";}
    @Override
     ...
     */
    @Override
    public List<Double> getRenderBogieOffsets(){return  Arrays.asList(0.5, -2.375);}
    /**
    ...
    @Override
    public float[][] modelOffsets() { return new float[][]{{0f,0.5f,0f}}; }
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new RussiaOne()};}
