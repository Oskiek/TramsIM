...
import tramsim.models.trains.Konstal105NaMl;
...
public class EntityKonstal105NaMl extends TrainBase {



    public static final Item thisItem = new ItemTransport(new EntityKonstal105NaMl(null), TramsIM.MODID,TramsIM.tramsimtabvehicle);


    public EntityKonstal105NaMl(UUID owner, World world, double xPos, double yPos, double zPos) {
        super(owner, world, xPos, yPos, zPos);
    }
    public EntityKonstal105NaMl(World world){
        super(world);
    }

    @Override
    public String transportName(){return "Konstal105NaMl";}
    @Override
    public String transportcountry(){return "Poland";}
    @Override
    public String transportYear(){return "2000+";}
    @Override
    ...
    public void registerSkins(){
        SkinRegistry.addSkin(this.getClass(),TramsIM.MODID, "textures/trams/konstal105naml_silesia.png", new String[]{"textures/trams/bogies/105nabogie.png"},
        "company.silesia", RailUtility.translate("standardlivery") + " " + RailUtility.translate("in.silesia") + ".");
        SkinRegistry.addSkin(this.getClass(),TramsIM.MODID, "textures/trams/konstal105naml_elblag.png", new String[]{"textures/trams/bogies/105nabogie.png"},
        "company.elblag", RailUtility.translate("standardlivery") + " " + RailUtility.translate("in.elblag") + ".");
    }
    @Override
    ...
    @Override
    public ModelBase[] getModel(){return new ModelBase[]{new Konstal105NaMl()};}
